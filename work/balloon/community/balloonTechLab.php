    ...
    <div class="wrap cs_wrap">     
		...
		<div class="container">
			...
			<div class="sub_topbanner">
				<div class="banner">
					...
					<div class="breadcrumb">
						...
						<div class="catebox">
							<button type="button" class="catetit cate_btn">
								<span class="txt">열기구 비행안전 기술연구소</span>
								<span class="arrow"></span>
							</button>
							<div class="popup cate_popup">
								<div class="linkbox">
									...
									<a href="<?php echo $path ?>community/balloonTechLab.php" class="link on">열기구 비행안전 기술연구소</a>
			...
			<section class="sub_section cs_sec">
				<div class="inner2">
					<div class="board_toplogo">
						<img src="<?php echo $path ?>img/ms2_logo_lab.png" alt="" class="img">
					</div>
					<div class="board_titbox">
						<p class="tit">열기구 비행안전 기술연구소</p>
						<p class="desc">HOT AIR BALLOON FLIGHT SAFETY TECH LAB</p>
					</div>
				</div>
				<div class="cs_banner" style="background-image:url(<?php echo $path ?>img/cs_banner1.jpg)"></div>
				<div class="inner2">
