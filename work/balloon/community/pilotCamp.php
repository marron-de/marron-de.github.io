						...
						<div class="catebox">
							...
							<div class="popup cate_popup">
								<div class="linkbox">
									...
									<a href="<?php echo $path ?>community/pilotCamp.php" class="link on">조종사 체험 캠프</a>
								</div>
							</div>
						</div>
					</div>
			...
			<section class="sub_section cs_sec">
				<div class="inner2">
					<div class="board_toplogo">
						<img src="<?php echo $path ?>img/ms2_logo_camp.png" alt="" class="img">
					</div>
					<div class="board_titbox">
						<p class="tit">조종사 체험 캠프</p>
						<p class="desc">PILOT SCHOOL CAMP</p>
					</div>
				</div>
				<div class="cs_banner" style="background-image:url(<?php echo $path ?>img/cs_banner2.jpg)"></div>
				<div class="inner2">
