		...
		<div class="modal_body">
			<div class="term_area">
				<div class="term_txtbox">
					...
					<p class="desc">
						1. 이 약관은 전기통신사업법 및 동법 시행령에 의하여 '벌룬어드벤처코리아'(이하 당사라 한다)가 제공하는 인터넷 여행 서비스(이하 서비스)인 '벌룬어드벤처코리아' 의
						이용조건, 절차, 그리고 회원규칙에 관한 사항과 기타 필요한 사항을 규정함을 목적으로 합시다.
					</p>
				</div>
				<div class="term_txtbox">
				...
				<div class="term_txtbox">
					...
					<p class="desc">
						1. 당사는 서비스 이용자의 정보수집시 반드시 당해 이용자의 동의를 얻어 필요한 최소한의 정보만을 수집하며, 이용자는 온라인을 통하여 수시로 본인의 신장정보를 열람, 정정
						또는 삭제할 수 있습니다. <br>
						2. 당사는 이용고객의 개인 신상정보를 본인의 동이없이는 절대 제3자에게 제공, 분실 또는 유출하여서는 아니되며 이를 지키지 않아서 발생하는 고객의 모든 피해에 대한 책임은
						당사에 있습니다. 단, 다음의 각호에 해당하는 경우에는 예외로 합니다. <br>
						...
						이용자의 동의 없이 개인정보가 유출되는 등 부당한 사례에 발견했을 때에는 전화 02-654-4111, 전자우편 speedtour@speedtour.co.kr,
						한국소비자보호원, 경실련 등을 통해 신고할 수 있으며, 이에 대해 본사는 적절한 조치를 취할 의무가 있습니다.
					</p>
				</div>
				<div class="term_txtbox">
					...
					<p class="desc">
						1. 아이디, 이메일과 비밀번호에 관한 모든 관리책임은 회원에게 있습니다. 회원에게 부여된 아이디(ID), 이메일(E-mail), 비밀번호의 관리소홀, 부정사용에 의하여
				...
				<div class="term_txtbox">
					...
					<p class="desc">
						...
						3. 이용자는 회사의 사전승낙없이는 서비스를 이용하여 영업활동을 할 수 없으며, 영업활동의 결과와 이용자가 규정에 위반한 영업활동을 이용하여 발생한 결과에 대하여 책임을
						지지 않습니다.
					</p>
				</div>
				<div class="term_txtbox">
				...
				<div class="term_txtbox">
					...
					<p class="desc">
						1. 당사가 제 5 장 제1조 2항 각호의 규정에 의하여 이용제한을 하고자 하는 경우에는 그 사유과 일시, 기간, 기타사항을 정하여 이메일(E-mail)이나 기타방법에
						의하여 해당 이용자나 대리인에게 통지합니다. 단, 회사가 긴급하게 이용을 정지할 필요가 있다고 인정하는 경우에는 그러하지 아니합니다. <br>
