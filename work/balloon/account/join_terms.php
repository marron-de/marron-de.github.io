			...
			<section class="sub_section ver2 ac_sec join">
				<div class="inner2">
									...
									<div class="acc_tit">
										<div class="check_box">
											...
											<label for="terms1" class="label_check">
												<span class="point">(필수)</span> 이용약관 동의
											</label>
										</div>
										<div class="arrow"></div>
									</div>
										...
										<li>
											<div class="term_area">
												<div class="term_txtbox">
													...
													<p class="desc">
														1. 이 약관은 전기통신사업법 및 동법 시행령에 의하여 '벌룬어드벤처코리아'(이하 당사라 한다)가 제공하는 인터넷 여행 서비스(이하 서비스)인 '벌룬어드벤처코리아' 의 이용조건, 절차, 그리고 회원규칙에 관한 사항과 기타 필요한 사항을 규정함을 목적으로 합시다.
													</p>
												</div>
												<div class="term_txtbox">
								...
								<div class="all_chekbox check_box">
									<div class="check_box">
										...
										<label for="allTerms" class="label_check">
											<span class="underline">이용약관, 개인정보 수집 및 이용에 모두 동의</span> 합니다.
										</label>
									</div>								
								</div>
							</div>
					...
					<div class="button_box">
						<a href="<?php echo $path ?>account/login.php" class="button typeB">취소</a>
						<a href="<?php echo $path ?>account/join_info.php" class="button typeA">다음</a>
					</div>	
