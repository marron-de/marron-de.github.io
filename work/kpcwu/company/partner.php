						...
						<div class="contbox">
							<div class="partner_box">
								...
								<div class="button_box">
									<button type="button" class="button typeB auto">취소</button>
									<button type="button" class="button typeA auto">신청</button>
								</div>
							</div>
						</div>
					</div>
