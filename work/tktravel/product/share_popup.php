            ...
            <div class="modal_box">
                ...
                <div class="modal_body">
					<div class="sns_box">
						...
						<div class="item">
							<a href="" class="link">
								<img src="<?php echo $path ?>img/share_whatapp.png" alt="" class="icon">
								<p class="txt">Whatapp</p>
							</a>
						</div>
						<div class="item">
							<a href="" class="link">
								<img src="<?php echo $path ?>img/share_line.png" alt="" class="icon">
								<p class="txt">LINE</p>
							</a>
						</div>
						<div class="item">
							<a href="" class="link">
								<img src="<?php echo $path ?>img/share_wechat.png" alt="" class="icon">
								<p class="txt">Wechat</p>
							</a>
						</div>
						<div class="item">
							<a href="" class="link">
