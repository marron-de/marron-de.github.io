...
<body>
    ...
    <div class="wrap main_wrap">     
        ...
        <div class="container">
            ...
            <section class="section inquiry_section list">
                <div class="inner">
					<div class="m_titbox">
						<p class="tit" data-aos="fade-up">Inquiry</p>
						<p class="desc" data-aos="fade-up">
							프로젝트 문의 및 견적 요청을 남겨주시면 <br>
							빠르게 안내해 드립니다.
						</p>
					</div>
					<div class="contbox">
						<div class="tbl_wrap" data-aos="fade-up">
							<table class="tbl">
								<colgroup>
								...
								<tbody>
									<tr>
										...
										<td data-th="제목" class="full_td">
											<a href="inquiry_view.php" class="link">
												문의글 입니다.
											</a>
										</td>
										<td data-th="작성자">홍**</td>
									...
									<tr>
										...
										<td data-th="제목" class="full_td">
											<a href="inquiry_view.php" class="link">
												<i data-lucide="corner-down-right" class="icon icon_answer"></i>
												<span class="bold">[RE]</span> 문의글 답변입니다.
											</a>
										</td>
										<td data-th="작성자">홍**</td>
										<td data-th="등록일">2025.05.26</td>
									...
									<tr>
										<td data-th="번호">3</td>
										<td data-th="제목" class="full_td">
											<a href="inquiry_view.php" class="link secret_mode">
												문의글 입니다.
												<i data-lucide="lock-keyhole" class="icon icon_lock"></i>
											</a>
										</td>
										<td data-th="작성자">홍**</td>
										<td data-th="등록일">2025.05.26</td>
						...
						<div class="tbl_bottom" data-aos="fade-up">
							<div class="leftbox">
								<div class="paging">
							...
							<div class="rightbox">
								...
								<a href="#none" class="button typeB inquiry_btn">문의하기</a>
							</div>
						</div>
					</div>
                </div>
