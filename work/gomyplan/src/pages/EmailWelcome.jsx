      ...
      <div className="container">
        <EmailPage>
          ...
          <EmailCont>
            ...
            <EmailList>
              <EmailListItem>Email address</EmailListItem>
              <EmailListItem>Mobile number</EmailListItem>
              <EmailListItem>Social media account</EmailListItem>
              <EmailListItem>Etc.</EmailListItem>
            </EmailList>
          </EmailCont>
          <BigButton className="pc_ver">Update Information</BigButton>
        </EmailPage>
      </div>
