...
const CustomCalendar2 = ({ placeholder }) => {
  ...
  return (
    <CalendarContainer>
      <DropdownButton onClick={handleShow} $isOpen={show}>
        <DropdownTxt className={!nowDate && "nodate"}>{nowDate ? nowDate : placeholder}</DropdownTxt>
      </DropdownButton>
      <Modal show={show} onHide={handleClose} className="type1">
        <Modal.Body>
          ...
          <Calendar
            ...
            value={nowDate ? new Date(nowDate) : new Date()}
