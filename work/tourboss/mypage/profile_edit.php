					...
					<div class="sub_titbox">
						...
						<div class="breadcrumb">
							...
							<div class="catebox">
								...
								<div class="popup cate_popup">
									<div class="linkbox">
										<a href="<?php echo $path ?>mypage/profile_edit.php" class="link on">회원 정보 수정</a>
										<a href="<?php echo $path ?>mypage/profile_delete.php" class="link">회원 탈퇴</a>
									</div>
								</div>
							</div>
						</div>
