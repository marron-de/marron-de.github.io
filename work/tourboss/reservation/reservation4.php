							...
							<div class="re_box re_box3">
								...
								<div class="re_contbox">
									<div class="form_box">
										<div class="form_item input_box">
											<p class="label_text">
												<span class="required">체크인시간</span>
											</p>
											<div class="input_flex">
												<div class="select_box full">
													<select class="select">
										...
										<div class="form_item input_box">
											<p class="label_text">
												<span class="required">추가 요청 사항</span>
											</p>
											<ul class="accordion select_box filter_ver">
												<li>
													<div class="acc_tit select" data-placeholder="추가 요청 사항을 선택해주세요.">
														<span class="txt">추가 요청 사항을 선택해주세요.</span>
														<span class="arrow"></span>
													</div>
													<ul class="select_wrap">
														<div class="select_list">
															...
															<div class="check_wrap ver2">
																<div class="check_box">
																	<input type="checkbox" name="" id="requests-1" class="input_check">
																	<label for="requests-1" class="label_check all_check">전체선택</label>
																</div>
																<div class="check_box">
																	<input type="checkbox" name="requests" id="requests-2" class="input_check">
																	<label for="requests-2" class="label_check">고층 객실</label>
																</div>
																<div class="check_box">
																	<input type="checkbox" name="requests" id="requests-3" class="input_check">
																	<label for="requests-3" class="label_check">저층 객실</label>
																</div>
																<div class="check_box">
																	<input type="checkbox" name="requests" id="requests-4" class="input_check">
																	<label for="requests-4" class="label_check">금연 객실</label>
																</div>
																<div class="check_box">
																	<input type="checkbox" name="requests" id="requests-5" class="input_check">
																	<label for="requests-5" class="label_check">흡연 객실</label>
																</div>
															</div>
														</div>
													</ul>
                ...
                <div class="modal_body">
					<div class="term_area">
						<div class="term_txtbox">
							...
							<p class="desc">
								1. 이 약관은 전기통신사업법 및 동법 시행령에 의하여 '여행대장'(이하 당사라 한다)가 제공하는 인터넷 여행 서비스(이하 서비스)인 '여행대장' 의 이용조건, 절차, 그리고 회원규칙에 관한 사항과 기타 필요한 사항을 규정함을 목적으로 합시다.
							</p>
						</div>
						<div class="term_txtbox">
            ...
            <div class="modal_box">
                ...
                <div class="modal_body">
					<div class="term_area">
						<div class="term_txtbox">
							<p class="desc">
								'여행대장'은 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다. 회사는 개인정보취급방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
								<br><br>
