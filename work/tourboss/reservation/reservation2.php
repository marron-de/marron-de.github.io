				...
				<div class="inner layout">
					<div class="cont_area">
						...
						<div class="re_sec re_sec_info">
							...
							<div class="re_box re_box3">
								...
								<div class="re_contbox">
									<div class="form_box">
										<div class="form_item input_box">
											<p class="label_text">
												<span class="required">항공편</span>
											</p>
											<input type="text" class="input_text" placeholder="항공편을 입력해 주세요">
										</div>
										<div class="form_item input_box">
											<p class="label_text">
							...
							<div class="re_box re_box4">
								<div class="re_titbox">
									<p class="re_tit">차량 종류 및 대수</p>
								</div>
								<div class="re_contbox">
										...
										<div class="swiper vhc_list">
											<div class="swiper-wrapper">
												<div class="swiper-slide item">
													...
													<div class="imgbox">
														<img src="<?php echo $path ?>img/vhc_car1.png" alt="" class="img">
													</div>
													<div class="txtbox">
														<div class="infobox">
															<div class="infoitem">
												...
												<div class="swiper-slide item">
													...
													<div class="imgbox">
														<img src="<?php echo $path ?>img/vhc_car2.png" alt="" class="img">
													</div>
													<div class="txtbox">
														<div class="infobox">
															<div class="infoitem">
												...
												<div class="swiper-slide item">
													...
													<div class="imgbox">
														<img src="<?php echo $path ?>img/vhc_car3.png" alt="" class="img">
													</div>
													<div class="txtbox">
														<div class="infobox">
															<div class="infoitem">
												...
												<div class="swiper-slide item">
													...
													<div class="imgbox">
														<img src="<?php echo $path ?>img/vhc_car4.png" alt="" class="img">
													</div>
													<div class="txtbox">
														<div class="infobox">
															<div class="infoitem">
												...
												<div class="swiper-slide item">
													...
													<div class="imgbox">
														<img src="<?php echo $path ?>img/vhc_car5.png" alt="" class="img">
													</div>
													<div class="txtbox">
														<div class="infobox">
															<div class="infoitem">
							...
							<div class="re_box re_box4">
								<div class="re_titbox">
									<p class="re_tit">탑승 인원/수하물</p>
								</div>
								<div class="re_contbox">
									<div class="re_controls">
										<div class="input_box">
											<span class="label_text">
												<span class="txt">성인</span>
												<span class="small">12세 이상</span>
											</span>
											<div class="control_box ver3">
