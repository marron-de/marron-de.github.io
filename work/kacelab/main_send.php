<?php
    ...
    $title = inputPost($_POST['title']); // 제목 
                ...
                <td>
                    <table border='0' cellpadding='0' cellspacing='0' class='mail_box' style='font-size: 14px;'  width='100%'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th style='background-color: #f5f5f7;border: 1px solid #e2e2e2; padding: 10px; width: 140px;'>제목</th>
                                <td style='border: 1px solid #e2e2e2; padding: 10px;'>$title</td>
                            </tr>
                            <tr>
