        ...
        <div class="frame-c">
            <div class="container">
                <div class="frame-d">
                    ...
                    <span class="dapsa">3특/12특 한국 대학 특례입학</span>
                </div>
            </div>
        </div>
            ...
            <div class="holding_cont">
                <div class="frame-16">
                    <div class="frame-17">
                        <div class="frame-18">
                            <div class="frame-19">
                                <span class="dapsa-jeong-mi-deul-i-deul-eo-gap-ni-da">3특/12특 한국 대학 특례입학</span >
                            </div>
                            <div class="frame-1a">
                                <div class="tooltip">
                        ...
                        <span
                            class="muryo-yuhag-seobiseu-wa-ibsi-keon-sel-ting-kkaji-dayang-han-seobiseu-je-gong">원서대행부터 에세이 첨삭 및 전공상담 통합관리</span >
                    </div>
                    <div class="frame-1d">
                        <!-- <div class="tags-1e">
                        ...
                        <div class="keulraeseu">
                            <span class="yeong-eo">HKU의대생멘토</span>
                        </div>
                    </div>
                </div>
                <div class="section-c">
            ...
            <div class="floating_cont sidebar">
                <div class="floating_wrap">
                    <div class="sseom-neol ver2">
                        <div class="mal-lei-si-a-dae-hag prcd10"></div>
                    </div>
                    <div class="frame-14f">
                        <div class="frame-150">
