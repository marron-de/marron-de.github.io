            ...
            <div class="holding_cont">
                <div class="frame-16">
                    <div class="frame-17">
                        ...
                        <span
                            class="muryo-yuhag-seobiseu-wa-ibsi-keon-sel-ting-kkaji-dayang-han-seobiseu-je-gong">입학컨설팅, 단일컨설팅, 자소서 첨삭 3가지 서비스</span >
                    </div>
                    <div class="frame-1d">
                        <!-- <div class="tags-1e">
                        ...
                        <div class="keulraeseu">
                            <span class="yeong-eo">1개교집중</span>
                        </div>
                        <div class="frame-1f">
                            <span class="text-16">NUS출신관리</span>
                        </div>
                    </div>
                </div>
                <div class="section-c">
                    ...
                    <div class="frame-14f">
                        <div class="frame-150">
                            <div class="tab_navbox notab frame-151">
                                ...
                                <a href="<?php echo G5_URL ?>/page/?pid=procedure_detail23_1" class="tab_nav on frame-152">단일컨설팅</a>
