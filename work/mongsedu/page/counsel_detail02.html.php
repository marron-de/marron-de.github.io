        ...
        <div class="frame-c">
            <div class="container">
                <div class="frame-d">
                    ...
                    <span class="dapsa">한국 인가/비인가 국제학교 상담</span>
                </div>
            </div>
        </div>
            ...
            <div class="holding_cont">
                <div class="frame-16">
                    <div class="frame-17">
                        <div class="frame-18">
                            <div class="frame-19">
                                <span class="dapsa-jeong-mi-deul-i-deul-eo-gap-ni-da">한국 인가/비인가 국제학교 상담</span >
                            </div>
                            <div class="frame-1a">
                                <div class="tooltip">
                                    <div class="content">
                        ...
                        <span
                            class="muryo-yuhag-seobiseu-wa-ibsi-keon-sel-ting-kkaji-dayang-han-seobiseu-je-gong">송도/제주 외 경기권 학교 통합</span >
                    </div>
                    <!-- <div class="frame-1d">
                        <div class="tags-1e">
                            ...
                            <li id="content-1">
                                        ...
                                        <div class="frame-2d">
                                            <div class="frame-2e">
                                                <span class="school-visit-counseling">
                                                    한국에 있는 인가 국제학교 (송도/제주)의 특징을 비교하고, 비인가 국제학교 약 (서울/경기권) 학교들을 한번에 파악하여 <br/>
                                                    아이의 영어실력과 예산 및 거주지에 따라 추천학교를 선별해 드립니다.
                                                </span >
                                                <div class="frame-2e sm">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <span>인가</span>
                                                            <p>송도채드윅, NLCS, KIS, SJA 등 7개 학교</p>
                                                        </li>
                                                        <li>
                                                            <span>비인가</span>
                                                            <p>서울/경기권 주요국제학교 약 15개</p>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <div class="frame-2b cd">
                                    ...
                                    <div class="frame-2c">
                                        <div class="frame-2d">
                                            <div class="frame-2e">
                                                <span class="school-visit-counseling">인가 VS 비인가 국제학교 비교 분석 및 학교별 커리큘럼 (20분)</span >
                                                <div class="frame-2f"></div>
                                            </div>
                                            <div class="frame-30">
                                                <span class="curriculum-facility-tour">약 20여개 학교 커리큘럼 및 연령대별 추천학교 선정</span >
                                                <div class="frame-31"></div>
                                            </div>
                                            <div class="frame-32">
                                                <span class="local-team-counseling-interpreting">학비, 비용예산 및 입학시기 안내 (20분)</span >
                                                <div class="frame-33"></div>
                                            </div>
                                            <div class="frame-34">
                                                <span class="residential-area-tour">각 학교별 학비 및 기타 부대비용 상세 확인</span >
                                            ...
                                            <div class="frame-36">
                                                <span class="shopping-medical-education-infrastructure-guide">인가와 비인가 국제학교에 따른 진로 로드맵 상담</span >
                                                <div class="frame-37"></div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="frame-13c cd">
                                    ...
                                    <div class="frame-140">
                                        <div class="frame-141">
                                            <div class="frame-142">
                                                <div class="frame-143">
                                                    <div class="rectangle-144 cd02"></div>
                                                </div>
                                            </div>
                                            <div class="frame-145">
                                                <span class="span-mentor">이지형 부원장</span >
                                        ...
                                        <div class="frame-146">
                                            <div class="frame-147">
                                                ...
                                                <div class="frame-14a">
                                                    <span class="span-education">‧ 이화여대 정치외교 학사</span >
                                                    <span class="span-education-14b">‧ 칭화대 국제관계 석사</span >
                                                    <span class="span-consulting">‧ RISE Education 본사팀장</span >
                                                    <span class="span-coordinator">‧ 강남캠퍼스 원장역임</span >
                                                    <span class="span-coordinator">‧ 영유아 주니어 교육 및 입시교육상담 경력 10년 이상</span >
                                                </div>
                                            </div>
                                            ...
                                            <div class="frame-14d">
                                                ...
                                                <div class="frame-14e">
                                                    <span class="span-text">강남 유명 영유아 교육기관에서 10년간 부모님 상담을 해왔습니다. 따라서 국제학교 로드맵에 대해서 가장 확실하고 현실성있는 상담을 제공하고 아이 상황에 따라 적합한 학교를 선정해드릴 수 있습니다!</span >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="floating_cont sidebar">
                <div class="floating_wrap">
                    <div class="sseom-neol">
                        <div class="mal-lei-si-a-dae-hag cd02"></div>
                    </div>
                    <div class="frame-14f">
                        <div class="frame-150">
                            <div class="frame-157">
                                <div class="frame-158">
                                    <div class="frame-159">
                                        <span class="span-text-15a">이지형 부원장</span>
                                        <div class="frame-15b">
                                            <span class="time-15c">영유아 주니어 교육상담 경력 10년 이상</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="frame-15d">
                                    <!-- <img src="<?php echo EYOOM_THEME_URL; ?>/image/sub/img_cd04.png" alt=""> -->
                                    <div class="frame-2e sm float">
                                        <ul>
                                            <li>
                                                <span>상담비용</span>
                                                <p>5만원</p>
