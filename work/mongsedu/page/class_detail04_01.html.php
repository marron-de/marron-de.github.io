        ...
        <div class="frame-c">
            <div class="container">
                <div class="frame-d">
                    ...
                    <span class="dapsa">국제학교 입학 테스트 대비반</span>
                </div>
            </div>
        </div>
            ...
            <div class="holding_cont">
                <div class="frame-16">
                    <div class="frame-17">
                        <div class="frame-18">
                            <div class="frame-19">
                                <span class="dapsa-jeong-mi-deul-i-deul-eo-gap-ni-da">국제학교 입학 테스트 대비반</span >
                            </div>
                            <div class="frame-1a">
                                <div class="tooltip">
                    ...
                    <div class="ms title_area class" id="row-1">
                        <div class="tab">
                            <ul class="tab_tit">
                                ...
                                <li><a href="<?php echo G5_URL ?>/page/?pid=class_detail04_01" class="show">수업비용</a></li>
            ...
            <div class="floating_cont sidebar">
                <div class="floating_wrap">
                    <div class="sseom-neol">
                        <div class="mal-lei-si-a-dae-hag cls01_04"></div>
                    </div>
                    <div class="frame-14f">
                        <div class="frame-150">
                            <div class="frame-151">
                                <div class="frame-152">
                                    <span class="day-paid">국제학교 입학 테스트 대비반</span >
                                </div>
                                <div class="group-154">
