        ...
        <div class="frame-c">
            <div class="container">
                <div class="frame-d">
                    ...
                    <span class="dapsa">입학시험 대비반</span>
                </div>
            </div>
        </div>
            ...
            <div class="holding_cont">
                <div class="frame-16">
                    <div class="frame-17">
                        <div class="frame-18">
                            <div class="frame-19">
                                <span class="dapsa-jeong-mi-deul-i-deul-eo-gap-ni-da">국제학교 입학시험 대비반</span >
                            </div>
                            <div class="frame-1a">
                                <div class="tooltip">
                            ...
                            <li id="content-1">
								...
								<div class="frame-section ver2">
										...
										<ul class="curri_list">
											<li>
												...
												<div class="text_area">
													...
													<div class="t_txt">
														<span>문제유형 집중 안내</span>
														<p class="lst">‧ 자체 제작 기출문제 제공 (50문제)</p>
														<p class="lst">‧ 학년별 문제 유형 설명</p>
														<p class="lst">‧ 인터뷰 예시질문 및 답변 방법</p>
													</div>
												</div>
											</li>
											<li>
												...
												<div class="text_area">
													<span class="t_top">
														5회 정규반
														<small>5시간 (회당 60분)</small>
													</span>
													<div class="t_txt">
														<span>문제유형 및 실전 연습</span>
														<p class="lst">‧ 자체 제작 기출문제 제공 (50문제)</p>
														<p class="lst">‧ 실전 문제 연습 및 지도</p>
														<p class="lst">‧ 인터뷰 연습 및 피드백 제공</p>
														<p class="lst">‧ 실전 모의테스트 진행</p>
													</div>
												</div>
											</li>
										</ul>
									...
									<div class="note_txtbox">
										<p class="note_txt">* 체험형 수업과 정규수업 모두 자체제작한 교재를 배포하며, 약 50가지 문제로 구성되어 있습니다.</p>
										<div class="note_txt">* 선생님은 한국인/필리핀/원어민에서 랜덤으로 배정되고 학습관리자와의 상담을 통해 결정할 수 있습니다.</div>
									</div>
								</div>
                                <div class="line-2a"></div>
                                <div class="frame-section ver2" id="sec03">
									<div class="frame-titbox gap2">
										<p class="frame-title">수업 비용 안내 (체험형/정규형)</p>
										<p class="frame-desc3">
											몽선생에서는 오로지 현지에서 체류경험이 있고, 오랫동안 교육업에 종사한 경험자들로만 구성하여 확실하고 믿을 수 있는 유학수속 서비스를 제공하는 것을 원칙으로 합니다!
										</p>
									</div>
									<ul class="cost_list">
                                        <li>
