        ...
        <div class="frame-c">
            <div class="container">
                <div class="frame-d">
                    ...
                    <span class="dapsa">말레이시아 국립대 접수대행 서비스 안내</span>
                </div>
            </div>
        </div>
            ...
            <div class="holding_cont">
                <div class="frame-16">
                    <div class="frame-17">
                        <div class="frame-18">
                            <div class="frame-19">
                                <span class="dapsa-jeong-mi-deul-i-deul-eo-gap-ni-da">말레이시아 국립대 접수대행 서비스 안내</span >
                            </div>
                            <div class="frame-1a">
                                <div class="tooltip">
                        ...
                        <span
                            class="muryo-yuhag-seobiseu-wa-ibsi-keon-sel-ting-kkaji-dayang-han-seobiseu-je-gong">UM 말라야대학의 유학 수속 업무 대행</span >
                    </div>
                    <div class="frame-1d">
                        <!-- <div class="tags-1e">
                        ...
                        <div class="keulraeseu">
                            <span class="yeong-eo">국내유일</span>
                        </div>
                        <div class="keulraeseu">
                            <span class="yeong-eo">합격사례보유</span>
                        </div>
                    </div>
                </div>
                <div class="section-c">
                        ...
                        <ul class="panel">
                            <li id="content-1">
								<div class="frame-section ver2 mb" id="sec01">
									...
									<span class="field-trip-service">말라야 국립대 접수대행 서비스는 한국에서 유일하게 합격 사례를 보유한 몽선생의 여러 경험을 통해 학교와 직접 소통을 하고 입학에 필요한 조건, 서류체크, 원서접수까지 가능한 서비스 입니다.</span >
								</div>
                                ...
                                <div class="frame-section" id="sec02">
									...
									<div class="school_listbox on">
										<div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sch_logo_UM.png" alt="" class="img">
											</div>
											<div class="txtbox">
												<p class="tit">UM 말라야 국립대학교</p>
												<p class="desc">Universiti Malaya, UM</p>
											</div>
										</div>
									</div>
                                </div>
            ...
            <div class="floating_cont sidebar">
                <div class="floating_wrap">
                    <div class="sseom-neol ver2">
                        <div class="mal-lei-si-a-dae-hag prcd06"></div>
                    </div>
                    <div class="frame-14f">
                        <div class="frame-150">
                                ...
                                <div class="frame-15d">
                                    <div class="frame-15e">
                                        <span class="interview">
                                            말라야 국립대 접수대행 서비스는 한국에서 유일하게 합격 사례를 보유한 몽선생의 여러 경험을 통해 학교와 직접 소통을 하고 입학에 필요한 조건, 서류체크, 원서접수까지 가능한 서비스 입니다.
                                        </span >
                                    </div>
                                    <div class="button">
