        ...
        <div class="frame-c">
            <div class="container">
                <div class="frame-d">
                    ...
                    <span class="dapsa">싱가포르/홍콩 국립대학교 입학상담</span>
                </div>
            </div>
        </div>
            ...
            <div class="holding_cont">
                <div class="frame-16">
                    <div class="frame-17">
                        <div class="frame-18">
                            <div class="frame-19">
                                <span class="dapsa-jeong-mi-deul-i-deul-eo-gap-ni-da">싱가포르/홍콩 국립대학교 입학상담</span >
                            </div>
                            <div class="frame-1a">
                                <div class="tooltip">
                        ...
                        <span
                            class="muryo-yuhag-seobiseu-wa-ibsi-keon-sel-ting-kkaji-dayang-han-seobiseu-je-gong">NUS,HKU 출신이 직접 관여하여 전문적인 정보 제공</span >
                    </div>
                    <!-- <div class="frame-1d">
                        <div class="tags-1e">
								...
								<div class="frame-section ver2">
									...
									<div class="counselingbox ver2">
										...
										<div class="box_list">
											<div class="item">
												<p class="desc">
													<span class="txt">NUS, NTU, SMU, SUTD (싱가포르)</span>
												</p>
											</div>
											<div class="item">
												<p class="desc">
													<span class="txt">HKU, HKUST, CUHK (홍콩)</span>
												</p>
											</div>
										</div>
									</div>
								...
								<div class="frame-section ver2">
									...
									<div class="counselingbox2">
										...
										<div class="item">
											...
											<p class="tit">
												싱가포르 대학 5개교, 홍콩3개교 국립대 모두 포함
											</p>
										</div>
										<div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/counseling_cont_img23.jpg" alt="" class="img">
											</div>
											<p class="tit">
												정량평가 및 정성평가 전공별 확인하기 (20분)
											</p>
										</div>
										<div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/counseling_cont_img24.jpg" alt="" class="img">
											</div>
											<p class="tit">
												학과별 경쟁률 및 입학조건 확인 가능
											</p>
										</div>
										<div class="item">
											<div class="imgbox">
                                ...
                                <div class="frame-section">
                                    ...
                                    <div class="frame-140">
                                        <div class="frame-141">
                                            ...
                                            <div class="frame-145">
                                                <span class="span-mentor">김형수 팀장</span >
                                            </div>
                                        </div>
                                        ...
                                        <div class="frame-146">
                                            <div class="frame-147">
                                                <div class="frame-148">
													...
													<div class="tagbox-149">
														...
														<div class="tags-149">
															<span class="span-location">홍콩</span>
														</div>
													</div>
                                                </div>
                                                <div class="frame-14a">
                                                    <span class="span-education">‧ 서강대 SHAPE MBA 수료(University of Derby)</span >
                                                    <span class="span-education">‧ 해외 대학 입학 행정 6년 경력</span >
                                                    <span class="span-education">‧ 비즈니스 (상경계열) 수업 전담 5년 경력</span >
                                                    <span class="span-education">‧ 아시아 TOP 명문대 진학 상담</span >
                                                </div>
                                            </div>
                                            ...
                                            <div class="frame-14d">
                                                ...
                                                <div class="frame-14e">
                                                    <span class="span-text">국내에서 유일하게 아시아 명문대 카운셀러 역할을 7년동안 경험하며, 다양한 학력자의 입학 사례와 합격케이스를 직접 관리했습니다! 축적된 데이터와 상담경험으로 확실한 입학 안내를 약속합니다!</span >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="floating_cont sidebar">
                <div class="floating_wrap">
                    <div class="sseom-neol">
                        <div class="mal-lei-si-a-dae-hag cd09"></div>
                    </div>
                    <div class="frame-14f">
                        <div class="frame-150">
                            <div class="frame-157">
                                <div class="frame-158">
                                    <div class="frame-159">
                                        <span class="span-text-15a">김형수 팀장</span>
                                        <div class="frame-15b">
                                            <span class="time-15c">입시카운셀러 경력7년 (국립대전문)</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="frame-15d">
                                    ...
                                    <div class="frame-2e sm float">
                                        <ul>
                                            ...
                                            <li>
                                                <span>주요 상담분야</span>
                                                <p>NUS,NUS,NTU (싱가폴국립대)<br/>HKU, HKUST (홍콩대) 입시</p>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="button">
