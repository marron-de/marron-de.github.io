                        ...
                        <ul class="panel">
                            <li id="content-1">
								...
								<div class="frame-section ver3">
									...
									<div class="pointbox">
										<p class="txt">테스트 내용입니다. 테스트 내용입니다. 테스트 내용입니다. 테스트 내용입니다. 테스트 내용입니다. 테스트 내용입니다. 테스트 내용입니다. 테스트 내용입니다. 테스트 내용입니다. 테스트 내용입니다. 테스트 내용입니다. </p>
									</div>
								</div>
                                <div class="line-2a"></div>	
								<div class="frame-section ver2">
            ...
            <div class="floating_cont sidebar">
                <div class="floating_wrap">
                    <div class="sseom-neol">
                        <div class="mal-lei-si-a-dae-hag cd11"></div>
                    </div>
                    <div class="frame-14f">
                        <div class="frame-150">
                            <div class="frame-157">
