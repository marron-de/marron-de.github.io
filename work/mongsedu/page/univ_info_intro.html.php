...
<div class="sub-page page-procedure page-univ">
    ...
    <div class="msection univ_info_top">
        <div class="container">
            <div class="univ_main">
                <div class="ms title_area">
                    <span><b>몽선생 추천</b> 이달의 학교</span>
                </div>
                <div class="img_area">
                    <img src="<?php echo EYOOM_THEME_URL; ?>/image/sub/img_univmain.png" alt="말레이시아 국제학교">
                </div>
                <div class="text_area">
            ...
            <div class="counsel_list procedure s4 univ_list">
                <ul class="panel">
                    <li>
                        <ul class="mentor_list">
                            <li>
                                <div class="img_area">
                                    <img src="<?php echo EYOOM_THEME_URL; ?>/image/sub/thumb_univ01.png" alt="카플란 사립대학교">
                                </div>
                                <div class="text_area">
                                    <a href="#none">
                                        <div class="tag_area">
                            ...
                            <li>
                                <div class="img_area">
                                    <img src="<?php echo EYOOM_THEME_URL; ?>/image/sub/thumb_univ02.png" alt="서울대학교">
                                </div>
                                <div class="text_area">
                                    <a href="#none">
                                        <div class="tag_area">
                            ...
                            <li>
                                <div class="img_area">
                                    <img src="<?php echo EYOOM_THEME_URL; ?>/image/sub/thumb_univ03.png" alt="하버드 대학교">
                                </div>
                                <div class="text_area">
                                    <a href="#none">
                                        <div class="tag_area">
                            ...
                            <li>
                                <div class="img_area">
                                    <img src="<?php echo EYOOM_THEME_URL; ?>/image/sub/thumb_univ04.png" alt="옥스포드 대학교">
                                </div>
                                <div class="text_area">
                                    <a href="#none">
                                        <div class="tag_area">
