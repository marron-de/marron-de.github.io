...
<div class="sub-page page-special page-sogang sogang">
	<div class="banner_area sogang_top">
        <div class="container" data-aos="fade-up">
			<div class="txtbox">
				<p class="sub">몽선생 X 서강 글로벌패스웨이</p>
				<p class="tit">
					몽선생과 함께, 서강에서 세계로 <br>
					미국/싱가포르 대학 편입
				</p>
				<p class="desc">강력한 3가지 입학 혜택으로 준비하세요.</p>
			</div>
        </div>
    </div>
        ...
        <div class="container">
			...
			<div class="contbox">
				...
				<div class="item item3" data-aos="fade-up">
					...
					<p class="desc">
						몽선생 x 서강글로벌 x 싱가포르 대학의 MOU제휴를 통해, 미국 대학 뿐 만 아니라 싱가포르 대학 편입까지 다른 학생에 비해 더욱 다양한 선택 옵션을 가질 수 있습니다.
					</p>
				</div>
			</div>
        </div>
    ...
    <div class="msection special sogang sogang_sec2">
        <div class="container" data-aos="fade-up">
			<div class="sub_titbox">
				<p class="sub_txt1">
					<span class="color">서강 글로벌 패스웨이의 장점!</span> <br>
					어디서도 볼 수 없는 강력한 프로그램입니다.
				</p>
			</div>
			<div class="contbox">
				<div class="item item1">
					<div class="txtbox">
						<p class="tit">내신성적 걱정 NO!</p>
						<p class="desc">
							서강글로벌패스웨이는 고등학교 3학년 졸업에 준하는 학력만 있으면 누구나 지원 가능하며, 본 프로그램에서 취득한 학점으로 미국 및 해외대학에 진학할 수 있기 때문에 내신성적에 대한 부담이 없습니다.	
						</p>
					</div>
					<div class="imgbox">
						<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sogang_sec2_icon1.png" alt="" class="img">
					</div>
				</div>
				<div class="item item2">
					<div class="txtbox">
						<p class="tit">유학비용 부담 NO!</p>
						<p class="desc">
							미국 파트너쉽 대학에서 본 프로그램에서 취득한 학점을 최대 30학점까지 인정받을 수 있으며, 아울러 영국 파트너쉽 대학으로부터 파운데이션 과정으로 인정 받을 수 있어 1년 동안 유학에 필요한 비용을 절약할 수 있을 뿐만 아니라, 본 프로그램과 연계된 다양한 장학금 혜택을 받으실 수 있습니다.
						</p>
					</div>
					<div class="imgbox">
						<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sogang_sec2_icon2.png" alt="" class="img">
					</div>
				</div>
				<div class="item item3">
					<div class="txtbox">
						<p class="tit">
							미국 및 해외대학 <br class="tablet">
							진학보장 YES!
						</p>
						<p class="desc">
							본 프로그램은 미국 및 해외파트너쉽 대학과 연계하여 정식으로 학점인정 승인을 받은 프로그램으로 최소 1개교 이상 입학을 보장받을 수 있습니다.
						</p>
					</div>
					<div class="imgbox">
						<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sogang_sec2_icon3.png" alt="" class="img">
					</div>
				</div>
				<div class="item item4">
					<div class="txtbox">
						<p class="tit">국내 명문대학 학업 YES!</p>
						<p class="desc">
							본 프로그램 입학과 동시에 합격증서, 학생증, 학번 및 서강가족카드가 발급되며, 서강대 동문 자격을 부여 받아 서강대학교 내 기숙사, 도서관, 식당 등의 시설과 캠퍼스를 서강대학교 학생들과 동일하게 이용 가능합니다.
						</p>
					</div>
					<div class="imgbox">
						<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sogang_sec2_icon4.png" alt="" class="img">
					</div>
				</div>
			</div>
        </div>
    ...
    <div class="msection special sogang benefit sogang_sec3">
        <div class="container" data-aos="fade-up">
            <div class="sub_titbox">
				<p class="sub_txt4">스페셜 프로그램</p>
                <p class="sub_txt1 ver2">
					놓치지 마세요! <br>
					몽선생을 통해 접수 할 때 <br class="tablet">
					<span class="mob_color">강력한 입학혜택 3가지</span>
				</p>
            </div>
            <div class="counsel_list sp_sogangprog">
                <ul class="panel">
                    <li id="content-1">
                        <ul>
                            <li>
                                <div class="img_area">
                                    <img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/img_sogangbnf01.png" alt="">
                                </div>
                            </li>
                            <li>
                                <div class="img_area">
                                    <img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/img_sogangbnf02.png" alt="">
                                </div>
                            </li>
                            <li>
                                <div class="img_area">
                                    <img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/img_sogangbnf03.png" alt="">
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="msection special sogang univ sogang_sec4">
        <div class="container" data-aos="fade-up">
			<div class="sub_titbox">
				<p class="sub_txt1 ver2">
					입학 가능 대학교 알아보기 
					<span class="color pc">미국대학 옵션</span>
					<span class="color tablet">미국대학 + 싱가포르대학 옵션</span>
				</p>
				<p class="sub_txt3">
					서강글로벌센터는 미국 내 21개 대학 및 영국의 8개 <br class="tablet">
					 대학들과 파트너쉽을 가지고 있습니다.
				</p>
			</div>
			...
			<div class="uni_titbox">
				...
				<p class="tit">
					<span class="color">싱가폴 대학</span>옵션까지
				</p>
			</div>
    ...
    <div class="msection special sogang bottom sogang_sec5">
        <div class="container" data-aos="fade-up">
			<div class="txtbox">
            	<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sogang_sec5_img.png" alt="" class="logo">
				<p class="sub_txt1 ver2 tit">
					몽선생과 함께, 서강에서 세계로 <br>
					3가지 입학혜택을 받고 준비하세요.
				</p>
