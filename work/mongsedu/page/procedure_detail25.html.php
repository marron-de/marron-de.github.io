            ...
            <div class="holding_cont">
                <div class="frame-16">
                    <div class="frame-17">
                        ...
                        <span
                            class="muryo-yuhag-seobiseu-wa-ibsi-keon-sel-ting-kkaji-dayang-han-seobiseu-je-gong">10여개 대학교 전체 수수료 없이 입학수속 가능</span >
                    </div>
                    <div class="frame-1d">
                        <div class="tags-1e">
                        ...
                        <div class="keulraeseu">
                            <span class="yeong-eo">수수료0원</span>
                        </div>
                    </div>
                </div>
                <div class="section-c">
                        ...
                        <ul class="panel">
                            <li id="content-1">
								...
								<div class="frame-section ver3">
									...
									<div class="pointbox">
										<p class="txt">국내유일! 말레이시아대학 교직원 출신이 직접 관리</p>
									</div>
								</div>
                                ...
                                <div class="frame-section" id="sec02">
									...
									<div class="school_listbox">
										<div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sch_logo_Taylors.png" alt="" class="img">
											</div>
											<div class="txtbox">
												<p class="tit">테일러스</p>
												<p class="desc">Taylor's University</p>
											</div>
										</div>
										<div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sch_logo_INTI.png" alt="" class="img">
											</div>
											<div class="txtbox">
												<p class="tit">인티</p>
												<p class="desc">INTI International University & Colleges</p>
											</div>
										</div>
										<div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sch_logo_HELP.png" alt="" class="img">
											</div>
											<div class="txtbox">
												<p class="tit">헬프</p>
												<p class="desc">HELP University</p>
											</div>
										</div>
										<div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sch_logo_SEGi.png" alt="" class="img">
											</div>
											<div class="txtbox">
												<p class="tit">세기</p>
												<p class="desc">SEGi University</p>
											</div>
										</div>
										<div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sch_logo_Sunway.png" alt="" class="img">
											</div>
											<div class="txtbox">
												<p class="tit">선웨이</p>
												<p class="desc">Sunway University</p>
											</div>
										</div>
										<div class="item school_moreview2">
											...
											<div class="txtbox">
												...
												<p class="desc">Other universities in Malaysia</p>
											</div>
										</div>
										<div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sch_logo_MDIS.png" alt="" class="img">
											</div>
											<div class="txtbox">
												<p class="tit">MDIS</p>
												<p class="desc">Management Development Institute of Singapore</p>
											</div>
										</div>
										<div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sch_logo_Raffles.png" alt="" class="img">
											</div>
											<div class="txtbox">
												<p class="tit">레플즈</p>
                        ...
                        <div class="frame-150">
                            ...
                            <div class="frame-157 default_ver">
                                <div class="frame-158">
									...
									<p class="desc">
										입학수속과 정착까지 원스탑 서비스 제공
									</p>
                                </div>
                                <div class="frame-15d">
                                    <div class="frame-15e">
                                        <span class="interview">
                                            무료수속 서비스는 어떠한 비용을 지불하지 않고, 보다 쉽고 편리하게 입학준비가 가능합니다. 담당 실장님이 배정되어 1:1관리되고, 서류준비/원서접수를 맡길 수 있습니다.
                                        </span >
                                    </div>
                                    <div class="button">
