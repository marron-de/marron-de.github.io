                ...
                <div class="section-c tabs">
                    <div class="ms title_area class stickybox" id="row-1">
                        <div class="tab sticky">
                            <ul class="tab_tit">
                                <li><a href="<?php echo G5_URL ?>/page/?pid=class_detail06">CLASS소개</a></li>
                                ...
                                <li><a href="<?php echo G5_URL ?>/page/?pid=class_detail06_03" class="show">자주 묻는 질문</a></li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="container" style="display:block;">
                                        ...
                                        <div class="faq-box">
                                            <ul class="faq_list">
                                                ...
                                                <li>
                                                    <div class="question">일반 영어학원과 어떤 차이점이 있나요?</div>
                                                    <div class="answer">학생들의 레벨에 따라 개인 맞춤형 수업을 진행하고, 부족한 부분을 최대한 보완하여 집중적으로 수업을 진행하는 방식입니다!</div>
                                                </li>
                                                <li>
                                                    <div class="question">개강은 언제인가요?</div>
                                                    <div class="answer">1:1 과외 형식으로 개강일은 정해져 있지 않고, 레벨테스트 후 바로 시작이 가능합니다.</div>
                                                </li>
                                                <li>
                                                    <div class="question">수업은 전체 영어로 진행되나요?</div>
                                                    <div class="answer">원어민 선생님과 진행하여 기본적으로 모든 수업은 영어수업을 원칙으로 하고 있습니다.</div>
                                                </li>
                                                <li>
