...
<style>
    .mal-lei-si-a-dae-hag {
        background: url("../theme/eb4_basic/image/sub/thumb_prcd22.png") no-repeat center;
            ...
            <div class="holding_cont">
                <div class="frame-16">
                    <div class="frame-17">
                        ...
                        <span
                            class="muryo-yuhag-seobiseu-wa-ibsi-keon-sel-ting-kkaji-dayang-han-seobiseu-je-gong">무료 유학서비스와 입학컨설팅 (2가지 선택사항)</span >
                    </div>
                    <div class="frame-1d">
                        <div class="tags-1e">
                        ...
                        <div class="keulraeseu">
                            <span class="yeong-eo">포트폴리오관리</span>
                        </div>
                        <div class="frame-1f">
                            <span class="text-16">한국사무소</span>
                        </div>
                    </div>
                </div>
                            ...
                            <li id="content-1">
                                    ...
                                    <div class="frame-2c info">
                                        <div class="frame-2d">
                                            <div class="frame-2e1">
                                                ...
                                                <span class="school-visit-counseling">종합예술대학 한국 공식사무소 관리 (국내 단 한곳)</span >
                                            </div>
                                            <div class="frame-2e1">
                                                <div class="frame-2f2"></div>
                                                <span class="school-visit-counseling">포트폴리오, 에세이, 인터뷰 통합관리</span >
                                            </div>
                                            <div class="frame-2e1">
                                                <div class="frame-2f3"></div>
                                                <span class="school-visit-counseling">합격샘플 공개 및 1:1 면담 제공</span >
                                            </div>
                                            <div class="frame-2e1">
                                                <div class="frame-2f4"></div>
                                                <span class="school-visit-counseling">원서접수, 비자처리, 숙소안내 등 행정지원</span >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="frame-25 point">
                                    <div class="frame-26">
                                        ...
                                        <span class="field-trip-service">공식 인증된 라셀 종합예술대학의 한국 공식 사무소 관리!</span >
                                    </div>
                                </div>
                                <div class="frame-25">
                                    <div class="frame-26">
                                        ...
                                        <span class="field-trip-service">예술대 컨설팅은 포트폴리오 작품 구성부터, 에세이, 인터뷰, 영어공인점수 등 합격에 필요한 모든 관리를 맡기고 원서접수와 학교 행정까지 원스탑으로 관리되는 서비스 입니다.</span >
                                    </div>
                                </div>
                                    ...
                                    <div class="univ_list">
                                        <ul>
                                            <li>
                                                <!-- <span>일반 사립대 :</span> -->
                                                <p>
                                                    Lasalle College of the Arts, 라셀컬리지<br/>
                                                    UAS, 싱가포르 종합예술대학교<br/>
                                                    NAFA, 나파 컬리지
                                                </p>
                                            </li>
                                ...
                                <div class="frame-2b">
                                    ...
                                    <div class="frame-2c">
                                        <div class="frame-2d">
                                            <div class="frame-2e">
                                                <span class="school-visit-counseling">1. 포트폴리오 작품 구성 (전공별 합격샘플제공)</span >
                                                <div class="frame-2f"></div>
                                            </div>
                                            <div class="frame-30">
                                                <span class="curriculum-facility-tour">2. 1:1 온라인 면담 및 작품 피드백 (최소5회+)</span >
                                                <div class="frame-31"></div>
                                            </div>
                                            <div class="frame-32">
                                                <span class="local-team-counseling-interpreting">3. 자소서 샘플제공 / 첨삭 관리</span >
                                                <div class="frame-33"></div>
                                            </div>
                                            <div class="frame-34">
                                                <span class="residential-area-tour">4. 인터뷰 예시질문 제공 / 피드백관리</span >
                                                <div class="frame-35"></div>
                                            </div>
                                            <div class="frame-36">
                                                <span class="shopping-medical-education-infrastructure-guide">5. 원서접수 및 학교 행정처리 일괄</span >
                                                <div class="frame-37"></div>
                                            </div>
                                            <div class="frame-36">
                                                <span class="shopping-medical-education-infrastructure-guide">6. 비자신청, 숙소 안내 및 정착가이드</span >
                                                <div class="frame-37"></div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="floating_wrap">
                    ...
                    <div class="frame-14f">
                        <div class="frame-150">
                            <div class="frame-151">
                                <div class="frame-152">
                                    <span class="day-paid" onclick="location.href='<?php echo G5_URL ?>/page/?pid=procedure_detail22'" style="cursor:pointer;">입학컨설팅</span>
                                    <span class="day-paid-153" onclick="location.href='<?php echo G5_URL ?>/page/?pid=procedure_detail22_1'" style="cursor:pointer;">무료수속</span>
                                </div>
                                <div class="group-154">
