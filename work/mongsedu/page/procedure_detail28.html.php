                            ...
                            <li id="content-1">
                                ...
                                <div class="frame-section" id="sec02">
									...
									<div class="school_listbox on">
										<!-- <div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sch_logo_SUNY.png" alt="" class="img">
											</div>
											<div class="txtbox">
												<p class="tit">뉴욕주립대</p>
												<p class="desc">The State University of New York(SUNY)</p>
											</div>
										</div> -->
										<div class="item">
											<div class="imgbox">
										...
										<div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sch_logo_Kent.png" alt="" class="img">
											</div>
											<div class="txtbox">
												<p class="tit">겐트</p>
												<p class="desc">Kent State University</p>
											</div>
										</div>
										<div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sch_logo_George.png" alt="" class="img">
											</div>
											<div class="txtbox">
												<p class="tit">조지메이슨</p>
												<p class="desc">George Mason Universiry</p>
											</div>
										</div>
										<!-- <div class="item">
											<div class="imgbox">
												<img src="<?php echo EYOOM_THEME_URL; ?>/img/sub/sch_logo_sogang.png" alt="" class="img">
											</div>
											<div class="txtbox">
												<p class="tit">서강 글로벌 패스웨이 프로그램</p>
												<p class="desc">미국 편입학과정</p>
											</div>
										</div> -->
									</div>
                                </div>
