...
<div class="sub-page page-counsel">
    <div class="counsel-wrap container">
        <div class="counsel-title">
            ...
            <ul class="cs_info">
                <li>
                    <img src="<?php echo EYOOM_THEME_URL; ?>/image/sub/ico_picker.svg" alt="">
                    <div class="text_area">
                        <span>방문상담</span>
                ...
                <li>
                    <img src="<?php echo EYOOM_THEME_URL; ?>/image/sub/ico_phone.svg" alt="">
                    <div class="text_area">
                        <span>전화상담</span>
                        <p>010 8114 9003</p>
                    </div>
                ...
                <li>
                    <img src="<?php echo EYOOM_THEME_URL; ?>/image/sub/ico_kakaotalk.svg" alt="">
                    <div class="text_area">
                        <span>카톡상담</span>
