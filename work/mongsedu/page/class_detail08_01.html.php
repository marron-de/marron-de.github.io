            ...
            <div class="holding_cont">
                ...
                <div class="section-c tabs">
                    <div class="ms title_area class stickybox" id="row-1">
                        <div class="tab sticky">
                            <ul class="tab_tit">
                                ...
                                <li><a href="<?php echo G5_URL ?>/page/?pid=class_detail08_01" class="show">비용</a></li>
                    ...
                    <div class="classDetail_list tabs_cont">
                        <ul class="panel">
                            <li id="content-2" style="display:block;">
                                <div class="class_curri">
                                    <!-- <img src="<?php echo EYOOM_THEME_URL; ?>/image/sub/detail_class01_cost.png" alt=""> -->
                                    <ul class="cost_list">
                                        <li>
                                            <div class="tit">
                                                <span>
												...
												<div class="costbox">
													<span class="tablet">1,200,000원</span>
                                                	<span class="cost">회당 75,000원</span>
												</div>
                                            </div>
                                            <div class="detail">
                                    ...
                                    <div class="guide ver2">
                                        ...
                                        <ul>
                                            ...
                                            <li>* 수강비에는 교재가 포함되어 있지 않습니다. 몽선생 자체 제작 교재 구매가 별도로 필요합니다.</li>
