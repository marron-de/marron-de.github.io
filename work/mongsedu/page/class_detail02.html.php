                    ...
                    <div class="classDetail_list tabs_cont">
                        <ul class="panel">
                            <li id="content-1" style="display:block;">
                                ...
                                <div class="class_curri">
                                    <div class="tit_area">
                                        <span>전공이론 강의주제 <small>(상경계 전공이론 수업 예시)</small></span>
                                    </div>
                                            ...
                                            <div class="faq-box">
                                                <ul class="faq_list">
                                                    <li>
                                                        <div class="question">
                                                            <p>제 1강</p>
                                                            <span>Management 경영 1강</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>경영 기초, 비지니스환경, 경영 분석 등 경영학 기초 이론 이해하기</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 2강</p>
                                                            <span>Marketing 마케팅 1강</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>마케팅 환경, 소비자의사결정, SWOT분석 및 과제/시험 유형 알아보기</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 3강</p>
                                                            <span>Economic 경제 1강</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>거시/미시 경제 정의, 필수 단어 암기, Case Stduy를 통한 학과목 이해하기</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 4강</p>
                                                            <span>Economic 경제 2강</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>무역(trade), 재정정책, 경기변동 외 필수 단어 암기 및 학과목 이해하기</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 5강</p>
                                                            <span>Accounting 회계 1강</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>회계 기본 정의, 재무재표, 회계 주기 및 Accouting 핵심 용어 파악하기</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 6강</p>
                                                            <span>Accounting 회계 2강</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>재무재표, 예산, 회계원칙 및 대학 시험유형 문제 이해하기</p>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                ...
                                <div class="class_curri">
                                    <div class="tit_area">
                                        <span>에세이/토론 강의주제 <small>(에세이토론 수업 예시)</small></span>
                                    </div>
                                    <div class="msection faq_area">
                                        <div class="container">
                                            <div class="faq-box">
                                                <ul class="faq_list">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="answer">
                                                            <p>
                                                                통계, 경영, 경제, 마케팅, 회계 전공의 주요 영어로 어휘들 집중 훈련<br/>
                                ...
                                <div class="class_intro">
                                    ...
                                    <div class="text_area">
                                        ...
                                        <div class="descbox">
                                        	<p>
												해외대학 1학년에서 나오는 전공 이론 5과목을 수강하고, 전공 예습 및 과제 훈련
											</p>
                                        	<p>
