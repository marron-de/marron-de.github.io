        ...
        <div class="frame-c">
            <div class="container">
                <div class="frame-d">
                    ...
                    <span class="dapsa">듀오링고 수업 소개</span>
                </div>
            </div>
        </div>
            ...
            <div class="holding_cont">
                <div class="frame-16">
                    <div class="frame-17">
                        <div class="frame-18">
                            <div class="frame-19">
                                <span class="dapsa-jeong-mi-deul-i-deul-eo-gap-ni-da">듀오링고 수업 소개</span >
                            </div>
                            <div class="frame-1a">
                                <div class="tooltip">
                        ...
                        <span class="desc">원어민이 풀어주고, 원어민이 리뷰하는 듀오링고 DET 수업</span >
                    </div>
                    <div class="frame-1d">
                        <div class="tags-1e">
                ...
                <div class="section-c tabs">
                    <div class="ms title_area class" id="row-1">
                        <div class="tab">
                            <ul class="tab_tit">
                                <li><a href="<?php echo G5_URL ?>/page/?pid=class_detail01" class="show">수업소개</a></li>
                                ...
                                <div class="frame-25 class_sec1">
                                    <div class="frame-26">
                                        ...
                                        <span class="field-trip-service">
                                            몽선생 듀오링고 수업은 DET 전문 원어민 선생님이 문제를 함께 풀이하며 2개월안에 빠르게 목표 점수를 도달할 수 있도록 구성되어 있습니다. <br/>
                                            목표 점수에 빠르게 도달할 수 있도록 기출문제 교재를 통해 영역별 전략 훈련을 반복 훈련하는 과정입니다.
                                        </span >
                                    </div>
                                </div>
                                            ...
                                            <ul class="bnf_list">
                                                ...
                                                <li>
                                                    ...
                                                    <p>
                                                        ...
                                                        기출 문제를 실전처럼  
														<br class="pc"> 시험 적응력 강화
                                                    </p>
                                                </li>
                                                <li>
                                                    <span>03</span>
                                                    <p>
                                                        <b>최신 기출 문제가 궁금해요?</b><br/>
                                                        자체 제작된 DET 
														<br class="pc">기출 문제 교재 제공
                                                    </p>
                                                </li>
                                                <li>
                                                    <span>04</span>
                                                    <p>
                                                        <b>1:1 DET 기초 입문반도<br class="pc"> 준비되어 있어요.</b><br/>
                                                        처음부터 차근차근 시작해요
                                                    </p>
                                                </li>
                                            </ul>
                                    ...
                                    <div class="frame-26">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="text_area">
                                                        ...
                                                        <div class="t_txt">
                                                            ...
                                                            <p class="lst"><b>‧ 원어민 문제 풀이 추가 수업 8회 무상 제공</b></p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div class="text_area">
                                                        ...
                                                        <div class="t_txt">
                                                            <span>기초 설명 및 기출문제 풀이 중점 수업</span>
                                                            <p class="lst">‧ 원어민 강의 24회</p>
                                                            <p class="lst">‧ 주3회 (월12회, 총 24회)</p>
                                                            <p class="lst">‧ 최대 정원 6명</p>
                                                        </div>
                                                    </div>
                                                </li>
                                        ...
                                        <div class="guide">
                                            <ul>
                                                ...
                                                <li>* 반 배정은 듀오링고 레벨테스트를 거친 후 결정되며, 테스트는 무료 제공됩니다.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="faq-box">
                                                <ul class="faq_list">
                                                    <li>
                                                        <div class="question">
                                                            <p>제 1강</p>
                                                            <span>Vocabulary Building 전략 (문장기초)</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>고빈도 단어와 기본 문장 구조 익히기</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 2강</p>
                                                            <span>Listen & Type 반복연습 / 문제 유형</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>주요 리스닝 유형 익히기 및 청취-타이핑 정확도 향상</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 3강</p>
                                                            <span>Interactive Reading 실전&정답 풀이</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>독해 유형별 문제 접근법 익히기</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 4강</p>
                                                            <span>리스닝 요약하기, 글쓰기 전략 수업</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>듣고 핵심정보 요약 후 논리적으로 쓰기</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 5강</p>
                                                            <span>사진 묘사연습 스피킹 + 의견말하기</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>묘사력 향상 및 자신의 의견을 영어로 자연스럽게 표현하기</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 6강</p>
                                                            <span>스피킹 정확성 훈련, 단문에세이 유형 연습</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>문법 정확도와 발화 유창성 동시에 향상</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 7강</p>
                                                            <span>Writing comfort zone 만들기 (시간 내 작성훈련)</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>제한 시간 내 아이디어 정리 및 문단 완성 능력 강화</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 8강</p>
                                                            <span>Writing & Speaking 통합 실전문제 연습</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>실전 감각 익히기 및 약점 보완</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 9강</p>
                                                            <span>Listening 집중력 & Shadowing 훈련</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>발음, 억양, 리듬감 개선을 통한 청취 집중력 향상</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="question">
                                                            <p>제 10강</p>
                                                            <span>Grammar Patterns & Paraphrasing 실전 응용</span>
                                                        </div>
                                                        <div class="answer">
                                                            <p>문법 패턴과 의역 능력으로 문장 다양화</p>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
            ...
            <div class="floating_cont sidebar">
                <div class="floating_wrap">
                    <div class="sseom-neol">
                        <div class="mal-lei-si-a-dae-hag cls01_01"></div>
                    </div>
                    <div class="frame-14f">
                        <div class="frame-150">
                            <div class="frame-151">
