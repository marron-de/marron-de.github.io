        ...
        <div class="frame-c">
            <div class="container">
                <div class="frame-d">
                    ...
                    <span class="dapsa">초기정착 서비스</span>
                </div>
            </div>
        </div>
                        ...
                        <ul class="panel">
                            <li id="content-1">
                                ...
                                <div class="frame-section ver2" id="sec03">
									<div class="frame-titbox gap2">
										<p class="frame-title">서비스 비용안내</p>
										<p class="frame-desc3">
											초기정착 패키지 비용은 1달 기간의 범위 기준으로 책정됩니다. 이 기간 안에 총 5~7회의 동행서비스를 요청할 수 있으며, 특별히 필요한 부분에 더욱 많은 직원의 도움을 요청할 수 있습니다.
										</p>
									</div>
									<ul class="cost_list">
                                        <li>
