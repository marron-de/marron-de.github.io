        ...
        <div class="frame-c">
            <div class="container">
                <div class="frame-d">
                    ...
                    <span class="dapsa">주요 국제학교 입학시험 상담</span>
                </div>
            </div>
        </div>
            ...
            <div class="holding_cont">
                <div class="frame-16">
                    <div class="frame-17">
                        <div class="frame-18">
                            <div class="frame-19">
                                <span class="dapsa-jeong-mi-deul-i-deul-eo-gap-ni-da">주요 국제학교 입학시험 상담</span >
                            </div>
                            <div class="frame-1a">
                                <div class="tooltip">
                                    <div class="content">
                        ...
                        <span
                            class="muryo-yuhag-seobiseu-wa-ibsi-keon-sel-ting-kkaji-dayang-han-seobiseu-je-gong">말레이시아, 싱가포르 등 주요 국제학교 80개 대상</span >
                    </div>
                    <!-- <div class="frame-1d">
                        <div class="tags-1e">
                            ...
                            <li id="content-1">
                                        ...
                                        <div class="frame-2d">
                                            <div class="frame-2e">
                                                <span class="school-visit-counseling">
                                                    아이의 영어실력에 따라 입학테스트를 통과할 수 있을지에 대한 기초적인 상담이 가능하고, <br/>
                                                    국제학교에서 주로 어떤 유형이 나오는지 시험 유형에 대해서 확인해볼 수 있습니다
                                                </span >
                                ...
                                <div class="frame-2b cd">
                                    ...
                                    <div class="frame-2c">
                                        <div class="frame-2d">
                                            <div class="frame-2e">
                                                <span class="school-visit-counseling">국제학교에 따른 예상 시험문제 상담 (10분)   </span >
                                                <div class="frame-2f"></div>
                                            </div>
                                            <div class="frame-30">
                                                <span class="curriculum-facility-tour">말레이시아, 싱가포르 등 약 80여개 대상</span >
                                                <div class="frame-31"></div>
                                            </div>
                                            <div class="frame-32">
                                                <span class="local-team-counseling-interpreting">아이 영어실력 체크 및 준비방법 설명 (10분)       </span >
                                                <div class="frame-33"></div>
                                            </div>
                                            <div class="frame-34">
                                                <span class="residential-area-tour">현 상황에 따른 학습법 제안</span >
                                                <div class="frame-35"></div>
                                            </div>
                                            <div class="frame-36">
                                                <span class="shopping-medical-education-infrastructure-guide">시험 준비시기 및 방법안내 (5분)</span >
                                                <div class="frame-37"></div>
                                            </div>
                                            <div class="frame-36">
                                                <span class="shopping-medical-education-infrastructure-guide">필기, 인터뷰 등 각 시험 준비시기 안내</span >
                                                <div class="frame-37"></div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="frame-13c cd">
                                    ...
                                    <div class="frame-140">
                                        <div class="frame-141">
                                            <div class="frame-142">
                                                <div class="frame-143">
                                                    <div class="rectangle-144 cd05"></div>
                                                </div>
                                            </div>
                                            <div class="frame-145">
                                        ...
                                        <div class="frame-146">
                                            <div class="frame-147">
                                                ...
                                                <div class="frame-14a">
                                                    <span class="span-education">‧ 한국외대 TESOL이수</span >
                                                    <span class="span-education-14b">‧ 서강대학교 학사졸업</span >
                                                    <span class="span-consulting">‧ 외국계교육기업/학원 경력 다수</span >
                                                </div>
                                            </div>
                                            ...
                                            <div class="frame-14d">
                                                ...
                                                <div class="frame-14e">
                                                    <span class="span-text">10년 이상 영어유치원 및 외국계 교육 기업과 학원에서 아이들의 학교 입학에 관련한 경험을 하였고 각 상황에 따라 국제학교 입학할 수 있는 방법에 대해서 고민해왔습니다. 어려운 시험 제가 도와드리겠습니다</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="floating_cont sidebar">
                <div class="floating_wrap">
                    <div class="sseom-neol">
                        <div class="mal-lei-si-a-dae-hag cd05"></div>
                    </div>
                    <div class="frame-14f">
                        <div class="frame-150">
                            <div class="frame-157">
                                <div class="frame-158">
                                    <div class="frame-159">
                                        <span class="span-text-15a">홍수진 실장</span>
                                        <div class="frame-15b">
                                            <span class="time-15c">한국외대 TESOL 이수 실력자</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="frame-15d">
