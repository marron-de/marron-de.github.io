...
<footer class="footer">
	<div class="inner f_inner">
		<div class="f_logo_box">
			<img class="f_logo" src="<?php echo $path ?>img/main/f_logo.png" alt="푸터 로고">
		</div>
		<div class="f_info">
			<ul class="f_info_top">
				<li><a href="<?php echo $path ?>#"><span>개인정보 처리방침</span></a></li>
				<li><a href="<?php echo $path ?>#">이메일수집거부</a></li>
			</ul>
			...
			<ul>
				<li class="f_insta">
					<a href="https://www.instagram.com/tmtpizza_official?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank">
						<img src="<?php echo $path ?>img/main/f_ins_btn.png" alt="인스타그램 바로가기 버튼">
					</a>
				</li>
				<li class="f_ytb">
					<a href="#">
						<img src="<?php echo $path ?>img/main/f_ytb_btn.png" alt="유튜브 바로가기 버튼">
					</a>
				</li>
			</ul>
		</div>
...
<ul class="quick_menu">
	<li>
		<a href="<?php echo $path ?>franchise.php#franchise" class="franchise_now">
			<p>창업<br>문의</p>
		</a>
	</li>
	<li>
		<a href="#" class="scroll_top">
			<div class="top_btn_img">
				<img src="<?php echo $path ?>img/main/top_arrow.svg" alt="스크롤 탑 버튼">
			</div>
			<p>TOP</p>
		</a>
	</li>
