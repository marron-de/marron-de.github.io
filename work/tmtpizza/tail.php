...
if (strpos($current_url, 'new_main') !== false) {
    echo '<script src="' . G5_THEME_URL . '/js/new_main.js"></script>';
} elseif (strpos($current_url, 'new_brand') !== false) {
    echo '<script src="' . G5_THEME_URL . '/js/new_brand.js"></script>';
} elseif (strpos($current_url, 'new_franchise') !== false) {
    echo '<script src="' . G5_THEME_URL . '/js/new_franchise.js"></script>';
}
?>
