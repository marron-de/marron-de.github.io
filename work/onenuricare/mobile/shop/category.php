...
<div id="category">
    <div class="ct_wr">
        <?php if ($is_member) { ?>
        <div class="ct_cont ct_login ct_logout">
            <ul class="ct-btn">
                ...
                <li>
					<a href="<?php echo G5_BBS_URL; ?>/logout.php?url=shop">
						<!-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M4 18H6V20H18V4H6V6H4V3C4 2.44772 4.44772 2 5 2H19C19.5523 2 20 2.44772 20 3V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V18ZM6 11H13V13H6V16L1 12L6 8V11Z"></path></svg> -->
						 <i data-lucide="log-out" class="svgicon"></i>
						로그아웃
					</a>
				</li>
            </ul>
            ...
            <ul class="ct-info">
                ...
                <li>
                    <button type="button" class="today_btn">
						...
						<i data-lucide="clock-3" class="svgicon"></i>
                        <strong>오늘본상품</strong>
                    </button>
        ...
        <?php } else { ?>
        <div class="ct_cont ct_login">
            <ul class="ct-btn">
                <li>
					<a href="<?php echo G5_BBS_URL; ?>/login.php?url=<?php echo $urlencode; ?>">
						<!-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M4 15H6V20H18V4H6V9H4V3C4 2.44772 4.44772 2 5 2H19C19.5523 2 20 2.44772 20 3V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V15ZM10 11V8L15 12L10 16V13H2V11H10Z"></path></svg> -->
						<i data-lucide="log-in" class="svgicon"></i>
						로그인
					</a>
				</li>
            </ul>
            <!--<h2>Welcome</h2>-->
            <h2><strong>로그인</strong>해 주세요</h2>
            <ul class="ct-info">
                <li>
					<a href="<?php echo G5_SHOP_URL; ?>/mypage.php">
						<!-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M4 22C4 17.5817 7.58172 14 12 14C16.4183 14 20 17.5817 20 22H18C18 18.6863 15.3137 16 12 16C8.68629 16 6 18.6863 6 22H4ZM12 13C8.685 13 6 10.315 6 7C6 3.685 8.685 1 12 1C15.315 1 18 3.685 18 7C18 10.315 15.315 13 12 13ZM12 11C14.21 11 16 9.21 16 7C16 4.79 14.21 3 12 3C9.79 3 8 4.79 8 7C8 9.21 9.79 11 12 11Z"></path></svg> -->
        ...
        <?php echo '<ul class="cate">'.PHP_EOL; ?>
		<?php
        ...
        <button type="button" class="pop_close">
			<!-- <span class="sound_only">카테고리 </span>닫기 -->
			<i data-lucide="x" class="svgicon"></i>
		</button>
    </div>
</div>
...
$(function (){
    ...
    $("button.sub_ct_toggle").on("click", function() {
        ...
        if($sub_ul.size() > 0) {
            ...
            if($sub_ul.is(":visible")){
                var $ancestors = $sub_ul.parents("ul.sub_cate");
                $("ul.sub_cate").not($sub_ul).not($ancestors).each(function(){
                    var $p = $(this).closest("li");
                    var $b = $p.children("button");
                    var t = $b.text();
                    t = t.replace(/닫기$/, "열기");
                    $b.removeClass("ct_cl").text(t);
                    $p.children("a").removeClass("active");
                    $p.children("ul.sub_cate").hide();
                });
                $parent_li.children("a").addClass("active");
            } else {
                $parent_li.children("a").removeClass("active");
            }
        }
    });
});
