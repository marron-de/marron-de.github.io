...
<div class="service_select service_select5">
	<button type="button" class="sel_btn">
		<span class="txt">Sports / Remedial Massage</span>
		<span class="arrow"></span>
	</button>
</div>
<div class="service_tab accordion service_tab5">
	...
	<li class="show">
		...
		<ul class="acc_cont" style="display: block;">
			<li class="acc_tabBtn on" onclick="serviceTab('1_1')">Sports / Remedial Massage</li>
		</ul>
	</li>
	<div class="btnbox">
...
<div class="swiper service_conts service_conts5">
	<div class="swiper-wrapper">
		<div class="swiper-slide contbox contbox1_1">
			<div class="imgbox">
				<img src="../img/service5_cont_img1_1.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
