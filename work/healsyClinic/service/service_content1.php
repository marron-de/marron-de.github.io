...
<div class="service_tab accordion service_tab1">
	<div class="close_bntbox">
	...
	<li class="show">
		...
		<ul class="acc_cont" style="display: block;">
			<li class="acc_tabBtn on" onclick="serviceTab('1_1')">Assessment</li>
			<li class="acc_tabBtn" onclick="serviceTab('1_2')">Diagnosis</li>
			<li class="acc_tabBtn" onclick="serviceTab('1_3')">Treatment</li>
			<li class="acc_tabBtn" onclick="serviceTab('1_4')">Follow-up management</li>
			<li class="acc_tabBtn" onclick="serviceTab('1_5')">Referral</li>
		</ul>
	</li>
	<li>
		<div class="acc_tit">
			<span class="txt">Treatment techniques</span>
			<span class="arrow"></span>
		</div>
		<ul class="acc_cont">
			<li class="acc_tabBtn" onclick="serviceTab('2_1')">Soft tissue mobilisation</li>
			<li class="acc_tabBtn" onclick="serviceTab('2_2')">Occupational Health</li>
			<li class="acc_tabBtn" onclick="serviceTab('2_3')">Dry needling</li>
			<li class="acc_tabBtn" onclick="serviceTab('2_4')">Fibreglass casting</li>
			<li class="acc_tabBtn" onclick="serviceTab('2_5')">Thermoplastic splinting</li>
			<li class="acc_tabBtn" onclick="serviceTab('2_6')">Joint manipulation</li>
			<li class="acc_tabBtn" onclick="serviceTab('2_7')">Joint mobilisation</li>
			<li class="acc_tabBtn lt-1" onclick="serviceTab('2_8')">Prehabilitation & rehabilitation exercise program &
				guidance</li>
		</ul>
	</li>
	<li>
		...
		<ul class="acc_cont">
			<li class="acc_tabBtn" onclick="serviceTab('3_1')">Concussion</li>
			<li class="acc_tabBtn" onclick="serviceTab('3_2')">Headaches / migraines</li>
			<li class="acc_tabBtn" onclick="serviceTab('3_3')">Neck</li>
			...
			<li class="acc_tabBtn" onclick="serviceTab('3_11')">Shin / calf</li>
...
<div class="swiper service_conts service_conts1">
	<div class="swiper-wrapper">
		<div class="swiper-slide contbox contbox1_1">
			<div class="imgbox">
				<img src="../img/service1_cont_img1_1.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
		...
		<div class="swiper-slide contbox contbox1_2">
			<div class="imgbox">
				<img src="../img/service1_cont_img1_2.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
		...
		<div class="swiper-slide contbox contbox1_3">
			<div class="imgbox">
				<img src="../img/service1_cont_img1_3.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
		...
		<div class="swiper-slide contbox contbox1_4">
			<div class="imgbox">
				<img src="../img/service1_cont_img1_4.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
		...
		<div class="swiper-slide contbox contbox1_5">
			<div class="imgbox">
				<img src="../img/service1_cont_img1_5.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
		...
		<div class="swiper-slide contbox contbox2_1">
			<div class="imgbox">
				<img src="../img/service1_cont_img2_1.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
		...
		<div class="swiper-slide contbox contbox2_2">
			<div class="imgbox">
				<img src="../img/service1_cont_img2_2.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Occupational Health</p>
				<div class="descwrap">
					<div class="descbox">
						<p class="desctit">
							<span class="num">1.</span>
							<span class="txt">Prevention of Work-Related Injuries</span>
						</p>
						<div class="descitem">
							<p class="desc dot">Ergonomic assessments (e.g., desk setup, lifting techniques)</p>
							<p class="desc dot">Education on posture, body mechanics, and injury prevention</p>
							<p class="desc dot">Exercise programs to reduce risk of musculoskeletal disorders (e.g.,
								back pain, RSI)</p>
						</div>
					</div>
					<div class="descbox">
						<p class="desctit">
							...
							<span class="txt">Rehabilitation for Return to Work</span>
						</p>
						<div class="descitem">
							<p class="desc dot">Physiotherapy treatment after a workplace injury</p>
							<p class="desc dot">Gradual return-to-work plans</p>
							<p class="desc dot">Exercise programs to reduce risk of musculoskeletal disorders (e.g.,
								back pain, RSI)</p>
						</div>
					</div>
					<div class="descbox">
						<p class="desctit">
							...
							<span class="txt">Workplace Health Promotion</span>
						</p>
						<div class="descitem no_spacing">
							<p class="desc dot">Wellness programs (stretching at work, physical activity, etc.)</p>
							<p class="desc dot">Stress management and mental well-being strategies</p>
							<p class="desc dot">Advice on reducing sedentary behavior</p>
						</div>
					</div>
					<div class="descbox">
						<p class="desctit">
							<span class="num">4.</span>
							<span class="txt">Fit-for-Work Assessments & Job-Specific Training</span>
						</p>
						<div class="descitem no_spacing">
							<p class="desc dot">Assessing whether a worker can meet the physical demands of a role</p>
							<p class="desc dot">Tailored training to build strength, mobility, or endurance for specific
								job tasks</p>
						</div>
					</div>
				</div>
		...
		<div class="swiper-slide contbox contbox2_3">
			<div class="imgbox">
				<img src="../img/service1_cont_img2_3.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Dry needling</p>
				<div class="descitem no_justify">
					<p class="desc dot">Myofascial pain syndrome</p>
					<p class="desc dot">Muscle tightness or spasms</p>
					<p class="desc dot">Chronic pain conditions (like neck pain, back pain, shoulder pain)</p>
					<p class="desc dot">Sports injuries</p>
					<p class="desc dot">Tendonitis</p>
					<p class="desc dot">Joint dysfunction</p>
				</div>
			</div>
		</div>
		<div class="swiper-slide contbox contbox2_4">
			<div class="imgbox">
				<img src="../img/service1_cont_img2_4.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Fibreglass casting</p>
				<div class="descitem">
					<p class="desc dot">Fractures (broken bones): arm, leg, wrist, ankle, etc.</p>
					<p class="desc dot">Severe sprains</p>
					<p class="desc dot">Post-operative support</p>
					<p class="desc dot">Correction of deformities in children (e.g., clubfoot)</p>
				</div>
			</div>
		</div>
		<div class="swiper-slide contbox contbox2_5">
			<div class="imgbox">
				<img src="../img/service1_cont_img2_5.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Thermoplastic splinting</p>
				<div class="descitem">
					<p class="desc dot">Post-surgical joint protection (e.g., tendon repairs)</p>
					<p class="desc dot">Fracture bracing (non-weight-bearing)</p>
					<p class="desc dot">Nerve injuries (e.g., radial/ulnar nerve palsy)</p>
					<p class="desc dot">Joint deformity correction (e.g., rheumatoid arthritis)</p>
					<p class="desc dot">Burn or scar contracture prevention</p>
					<p class="desc dot">Spasticity control in neurological conditions (e.g., stroke, cerebral palsy)</p>
				</div>
			</div>
		</div>
		<div class="swiper-slide contbox contbox2_6">
			<div class="imgbox">
				<img src="../img/service1_cont_img2_6.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Joint manipulation</p>
				<div class="descitem no_justify">
					<p class="desc dot">Releasing joint restrictions</p>
					<p class="desc dot">Reducing pain quickly</p>
					<p class="desc dot">Restoring lost motion</p>
					<p class="desc dot">Improving alignment or biomechanics</p>
				</div>
			</div>
		</div>
		<div class="swiper-slide contbox contbox2_7">
			<div class="imgbox">
				<img src="../img/service1_cont_img2_7.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Joint mobilisation</p>
				<div class="descitem no_justify">
					<p class="desc dot">Pain reduction</p>
					<p class="desc dot">Improving joint stiffness</p>
					<p class="desc dot">Increasing range of motion (ROM)</p>
					<p class="desc dot">Enhancing joint nutrition (synovial fluid movement)</p>
				</div>
			</div>
		</div>
		<div class="swiper-slide contbox contbox2_8">
			<div class="imgbox">
				<img src="../img/service1_cont_img2_8.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Prehabilitation & rehabilitation exercise program & guidance</p>
				<div class="descwrap ver2">
					<div class="descbox">
						<p class="desctit">
							<span class="num">1.</span>
							<span class="txt">Prehabilitation</span>
						</p>
						<p class="desc">Prehabilitation is a preventive physiotherapy program designed to enhance
							strength, flexibility, cardiovascular fitness, and neuromuscular control before surgery or
							in high-risk individuals (e.g., athletes, elderly, people with chronic conditions).</p>
					</div>
					<div class="descbox">
						<p class="desctit">
							<span class="num">2.</span>
					...
					<div class="descbox">
						<p class="desctit">
							<span class="num">3.</span>
							<span class="txt">Goals of Rehabilitation</span>
						</p>
						<div class="descitem no_all">
							<p class="desc dot">Restore strength, range, endurance</p>
							<p class="desc dot">Control pain and swelling</p>
							<p class="desc dot">Improve joint mobility</p>
							<p class="desc dot">Prevent complications (e.g., contractures, atrophy)</p>
							<p class="desc dot">Return to work, sport, or daily activities</p>
						</div>
					</div>
				</div>
				<p class="desctit mt justify">
					Telehealth consultations available upon request
				</p>
			</div>
		</div>

		<div class="swiper-slide contbox contbox3_1">
			<div class="imgbox">
				<img src="../img/service1_cont_img3_1.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Concussion</p>
				<div class="descwrap">
					<div class="descbox">
						<p class="desctit">
							<span class="num">1.</span>
		...
		<div class="swiper-slide contbox contbox3_2">
			<div class="imgbox">
				<img src="../img/service1_cont_img3_2.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Headaches / migraines</p>
				<div class="descwrap">
					<div class="descbox">
						<p class="desctit">
							<span class="num">1.</span>
		...
		<div class="swiper-slide contbox contbox3_3">
			<div class="imgbox">
				<img src="../img/service1_cont_img3_3.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				...
				<div class="descwrap">
					<div class="descbox">
						...
						<p class="desc ver2">Neck is a complex and delicate structure made up of seven small vertebrae,
							...
							pain arises when any of these structures are irritated, inflamed, or damaged. <br>Common
							types of neck pain and related issues include</p>
						<div class="descitem">
							<p class="desc dot">
							...
							<p class="desc dot">
								<span class="bold">Degenerative Conditions</span><br>
							...
							<p class="desc dot">
								<span class="bold">Torticollis (Wry Neck)</span><br>
					...
					<div class="descbox">
						...
						<div class="descitem no_spacing">
							...
							<p class="desc dot">
								<span class="bold">Numbness, Tingling, or Weakness</span><br>
							...
							<p class="desc dot">
								<span class="bold">Clicking or Grinding Sounds</span><br>
					...
					<div class="descbox">
						<p class="desctit">
							<span class="num">4.</span>
							<span class="txt">How Physiotherapy Can Help with Neck Pain</span>
						</p>
						<p class="desc ver2">Physiotherapy is highly effective in diagnosing and treating neck pain,
							providing relief, and preventing recurrence. Our approach focuses on identifying the root
							cause of your pain and empowering you with strategies for long-term management. <br>Here's
						...
						<div class="descitem">
							...
							<p class="desc dot">
								...
								contribute to neck pain and headaches. <br>
							...
							<p class="desc dot">
								<span class="bold">Ergonomic Advice</span><br>
							...
							<p class="desc dot">
								<span class="bold">Whiplash Rehabilitation</span><br>
							...
							<p class="desc dot">
								<span class="bold">Radiculopathy Management</span><br>
				...
				<p class="desctit mt">By addressing the underlying issues and providing you with the tools for
					self-care, physiotherapy aims to reduce your pain, restore full function, and help you return to
					your daily activities pain-free.</p>
			</div>
		</div>
		<div class="swiper-slide contbox contbox3_4">
			<div class="imgbox">
				<img src="../img/service1_cont_img3_4.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Shoulder</p>
				<div class="descwrap">
					<div class="descbox">
						<p class="desctit">
							<span class="num">1.</span>
		...
		<div class="swiper-slide contbox contbox3_5">
			<div class="imgbox">
				<img src="../img/service1_cont_img3_5.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Elbow / forearm</p>
				<div class="descwrap">
					<div class="descbox">
						<p class="desctit">
							<span class="num">1.</span>
		...
		<div class="swiper-slide contbox contbox3_6">
			<div class="imgbox">
				<img src="../img/service1_cont_img3_6.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Wrist / hand</p>
				<div class="descwrap">
					<div class="descbox">
						<p class="desctit">
							<span class="num">1.</span>
		...
		<div class="swiper-slide contbox contbox3_8">
			<div class="imgbox">
				<img src="../img/service1_cont_img3_8.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Hip / groin</p>
				<div class="descwrap">
					<div class="descbox">
						<p class="desctit">
							<span class="num">1.</span>
		...
		<div class="swiper-slide contbox contbox3_9">
			<div class="imgbox">
				<img src="../img/service1_cont_img3_9.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Thigh</p>
				<div class="descwrap">
					<div class="descbox">
						<p class="desctit">
							<span class="num">1.</span>
		...
		<div class="swiper-slide contbox contbox3_10">
			<div class="imgbox">
				<img src="../img/service1_cont_img3_10.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Knee</p>
				<div class="descwrap">
					<div class="descbox">
						<p class="desctit">
							<span class="num">1.</span>
		...
		<div class="swiper-slide contbox contbox3_11">
			<div class="imgbox">
				<img src="../img/service1_cont_img3_11.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Shin / calf</p>
				<div class="descwrap">
					<div class="descbox">
						<p class="desctit">
							<span class="num">1.</span>
		...
		<div class="swiper-slide contbox contbox3_12">
			<div class="imgbox">
				<img src="../img/service1_cont_img3_12.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Ankle and foot</p>
				<div class="descwrap">
					<div class="descbox">
						<p class="desctit">
							<span class="num">1.</span>
						...
						<div class="descitem">
							...
							<p class="desc dot">
								<span class="bold">Foot Arch Pain / Collapse</span><br>
