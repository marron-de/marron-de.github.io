...
<div class="service_tab accordion service_tab3">
	...
	<li>
		<div class="acc_tit">
			<span class="txt pc">Strength & Conditioning Programs</span>
			<span class="txt tablet lt-6">Podiatry Treatment Service & Conditions Treated</span>
			<span class="arrow"></span>
		</div>
		<ul class="acc_cont">
			<li class="acc_tabBtn" onclick="serviceTab('2_1')">Thermal modalities</li>
			<li class="acc_tabBtn" onclick="serviceTab('2_2')">Individualised Strength & <br class="tablet">
				Conditioning Programmes</li>
			<li class="acc_tabBtn" onclick="serviceTab('2_3')">Performance & Sports-Specific Training <br
					class="tablet">Programmes and Guidance</li>
			<li class="acc_tabBtn" onclick="serviceTab('2_4')">Pre / Post-Game Management & Guidance</li>
			<li class="acc_tabBtn" onclick="serviceTab('2_5')">In-Season & Off-Season <br class="tablet">Management
				Programme</li>
			<li class="acc_tabBtn" onclick="serviceTab('2_6')">Injury Prevention</li>
			<li class="acc_tabBtn" onclick="serviceTab('2_7')">Rehabilitation & Return to Sport / Activity</li>
			<li class="acc_tabBtn" onclick="serviceTab('2_8')">Pre & Post-Operative Strengthening</li>
		</ul>
	</li>
	<div class="btnbox">
...
<div class="swiper service_conts service_conts3">
	<div class="swiper-wrapper">
		...
		<div class="swiper-slide contbox contbox2_1">
			<div class="imgbox">
				<img src="../img/service3_cont_img2_1.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
		...
		<div class="swiper-slide contbox contbox2_2">
			<div class="imgbox">
				<img src="../img/service3_cont_img2_2.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
				<p class="title">Individualised Strength & Conditioning Programmes</p>
		...
		<div class="swiper-slide contbox contbox2_3">
			<div class="imgbox">
				<img src="../img/service3_cont_img2_3.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
		...
		<div class="swiper-slide contbox contbox2_4">
			<div class="imgbox">
				<img src="../img/service3_cont_img2_4.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
		...
		<div class="swiper-slide contbox contbox2_5">
			<div class="imgbox">
				<img src="../img/service3_cont_img2_5.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
		...
		<div class="swiper-slide contbox contbox2_6">
			<div class="imgbox">
				<img src="../img/service3_cont_img2_6.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
		...
		<div class="swiper-slide contbox contbox2_7">
			<div class="imgbox">
				<img src="../img/service3_cont_img2_7.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
		...
		<div class="swiper-slide contbox contbox2_8">
			<div class="imgbox">
				<img src="../img/service3_cont_img2_8.jpg" alt="" class="img">
			</div>
			<div class="txtbox">
