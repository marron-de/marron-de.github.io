...
<body>
    ...
    <div class="wrap cs_wrap">     
					...
					<div class="cont_area">
						<div class="sub_cont cs_list">
							<div class="tbl_cont">
								<div class="tbl_top">
									<div class="tbl_tabs">
										<div class="tab">온라인 문의</div>
										<div class="tab on">기업/단체 문의</div>
									</div>
									<div class="btnbox">
										<button type="button" class="button typeA auto">글쓰기</button>
									</div>
								</div>
								<div class="tbl_box">
									<table class="tbl ver2 medium">
										...
										<tbody>
											<tr>
												...
												<td>기업/단체 문의</td>
												<td class="full_td">
													<a href="#none" class="link secret_mode">
														송금 완료 및 확인 대기 중
														<img src="img/ic_lock.png" alt="" class="icon icon_lock">
														<img src="img/ic_file.png" alt="" class="icon icon_file">
													</a>
												</td>
												<td>LOOK KOREA</td>
												<td>2025.05.26</td>
											...
											<tr>
												...
												<td class="full_td">
													<a href="#none" class="link secret_mode">
														<img src="img/ic_re.png" alt="" class="icon icon_answer">
														[RE] 송금 완료 및 확인 대기 중
														<img src="img/ic_lock.png" alt="" class="icon">
													</a>
												</td>
												<td>LOOK KOREA</td>
												<td>2025.05.26</td>
											...
											<tr>
												...
												<td class="full_td">
													<a href="#none" class="link secret_mode">
														...
														<img src="img/ic_lock.png" alt="" class="icon">
														<img src="img/ic_file.png" alt="" class="icon">
													</a>
												</td>
												<td>LOOK KOREA</td>
												<td>2025.05.26</td>
											...
											<tr>
												...
												<td class="full_td">
													<a href="#none" class="link secret_mode">
														<img src="img/ic_re.png" alt="" class="icon">
        ...
        <div class="modal cs_psw_modal">
            <div class="modal_box">
				...
				<div class="input_box">
					<input type="text" class="input_text" placeholder="홍길동">
				</div>
	...
	<script>
  		 $(function() {
			...
			$('.side_menu .side_menulist .menuitem').eq(1).find(".side_menu_sublist .item").eq(1).addClass('on');
		});
	</script>
