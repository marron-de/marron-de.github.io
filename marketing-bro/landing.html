		...
		<div class="container">
			...
			<section class="landing_section sec1" id="MARKETINGBRO">
				...
				<div class="inner">
					<div class="txtbox">
						<p class="tit">
							검증된 데이터로 <br class="tablet">
							성공 공식을 설계한 <br>
							<span class="color">마케팅 전문가 그룹</span> <br>
							마케팅브로
						</p>
						<p class="desc">
							Over time, MarketingBro earns trust and <br class="tablet">
							delivers value <br class="pc">
				...
				<div class="inner">
					<div class="ls_titbox center">
						...
						<p class="ls_txt3">
							...
							최대 3억 8천만 원에 이르는 믿기 <br class="mobile">
							힘든 매출을	기록했습니다.
						</p>
					</div>
					<div class="numbox">
						<div class="item">
							<p class="num">8년</p>
							<p class="txt">실행사 경력</p>
						</div>
						<div class="item tablet bar"></div>
						<div class="item">
							<p class="num">20개</p>
							<p class="txt">테이블 수</p>
						</div>
						<div class="item">
							<p class="num">2억</p>
							<p class="txt">월 평균 매출</p>
						</div>
						<div class="item tablet bar"></div>
						<div class="item">
							<p class="num">3.8억</p>
							<p class="txt">최대 매출액</p>
						</div>
					</div>
					<div class="contbox">
						<div class="left">
							...
							<div class="txtbox">
								<p class="ls_txt3">
									...
									<br><br>
									저희는 맛집 운영의 노하우를 바탕으로, 현재도 진행 중인
									광고의 핵심적인 요소들을 클라이언트에게 제안하고
									있습니다. 이러한 마케팅 전략을 통해, 저희와 함께하는
									전국의 매장에 동일하게 적용시켜 큰 시너지를 얻을 수 있을 것입니다.
								</p>
							</div>
						</div>
						<div class="right">
			...
			<section class="landing_section sec3" id="SERVICE">
				<div class="inner">
					...
					<div class="phonebox">
						...
						<img src="img/ls3_phone_mob.png" alt="" class="tablet">
					</div>
				</div>
				<div class="contbox">
					<div class="txtbox inner">
						<p class="ls_txt3">
							...
							하고 있습니다.
							<br><br>
							마케팅브로에서 20테이블 매장을 1,000평의 매장까지 성장시킬 수 있었던 것은 데이터 기반의 마케팅을 통한
							성공적인 마케팅의 결과라 할 수 있습니다.
							<br><br>
							결국, 네이버 마케팅을 활용한 효과적인 전략은 단순한 광고를 넘어, 고객과의 신뢰를 구축하고 지속적인 성장을
					...
					<div class="imgbox">
						<img src="img/ls3_img_pc.png" alt="" class="pc">
						<img src="img/ls3_img_mob.png" alt="" class="tablet">
					</div>
				</div>
			</section>
			...
			<section class="landing_section sec4" id="DATA01">
				<div class="inner">
					...
					<div class="cardbox">
						<div class="item">
							<img src="img/ls4_icon1.png" alt="" class="icon">
							<p class="num">01</p>
							<p class="tit">시장의 전반적인 흐름</p>
							<p class="desc">
								네이버는 전체 검색 시장의 <span class="bold">약 70%를 차지</span>하고 있습니다. 
								<br class="tablet">
								<br class="tablet">								
								특히, 네이버 플레이스는 <span class="bold">식당 검색 및 예약에 있어 중요한 플랫폼</span>으로 자리잡고 있습니다.
							</p>
						</div>
						<div class="item">
							<img src="img/ls4_icon2.png" alt="" class="icon">
							<p class="num">02</p>
							<p class="tit">네이버 플레이스 마케팅 현황</p>
							<p class="desc">
								최근 네이버의 알고리즘이 지속적으로 고도화되면서 검색 결과에서 매장 정보가 더 잘 보여지기 위해선 정교한 운영 전략이 요구되고 있습니다. 
								<br class="tablet">
								<br class="tablet">										
								하지만 여전히 많은	인기 식당들은 검색 결과에서 우선적으로 노출되며 방문 고객 수 증가에 큰 영향을 받고 있습니다. 이에 따라, <span class="bold">노출 최적화 중심의 마케팅 전략</span>은 매출 성장을 원하는 매장에 <span class="bold">필수 요소</span>로 자리잡고 있습니다.
							</p>
						</div>
					</div>
				</div>
				<div class="databox">
					<div class="lined_bg"></div>
					<div class="inner">
						<div class="left">
							<div class="txtbox">
								<p class="tit">마케팅 효과 분석 및 매출 상승</p>
								<p class="desc">
									지역 경쟁 업체들보다 나의 매장이 먼저 노출되는 것은 동일한 메뉴를 <br class="pc">
									판매하더라도 매출에 큰 차이를 만들어냅니다.
								</p>
							</div>
							<div class="imgbox">
								<img src="img/ls4_graph1.png" alt="">
							</div>
						</div>
						<div class="right">
							<div class="imgbox">
								<img src="img/ls4_graph2_pc.png" alt="" class="pc">
								<img src="img/ls4_graph2_mob.png" alt="" class="tablet">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="inner">
					<div class="ls_titbox center">
						...
						<p class="ls_txt4">
							...
							<br><br>
							단순한 콘텐츠 발행이 아닌, ‘검색에 강한 콘텐츠 구조’와 ‘AI 알고리즘 기반 키워드 전략’으로
							<br class="pc">
							검색 트렌드를 선잠하고, 실제 방문으로 이어지는 유입을 창출합니다.
						</p>
					</div>
				</div>
				<div class="imgbox">
					<img src="img/ls5_img_pc.png" alt="" class="pc">
					<img src="img/ls5_img_mob.png" alt="" class="tablet">
				</div>
			</section>
			...
			<section class="landing_section sec6" id="DATA02">
				<div class="inner">
					...
					<div class="effectbox">
						<p class="title">장기간 마케팅 효과</p>
						<div class="descbox">
							<div class="item">
								<p class="tit">월매출</p>
								<p class="num">3,530만</p>
							</div>
							<div class="item">
								<p class="tit">ROAS</p>
								<p class="num">3,000%</p>
				...
				<div class="graphbox">
					<div class="lined_bg"></div>
					<img src="img/ls6_graph1_pc.png" alt="" class="graph pc">
					<img src="img/ls6_graph1_mob.png" alt="" class="graph tablet">
				</div>
				<div class="inner">
					<div class="contbox">
						<div class="titbox">
						...
						<div class="imgbox">
							<img src="img/ls6_graph2.png" alt="">
						</div>
					...
					<div class="contbox">
						<div class="item">
							<div class="top">
								<div class="left">
									<p class="num">
										STRATEGY <span class="color">01</span>
									</p>
									<p class="tit">매출 향상 효과 분석</p>
								</div>
								<div class="right">
									<img src="img/ls7_icon1.png" alt="" class="icon">
								</div>
							</div>
							<div class="line"></div>
							<div class="bottom">
						...
						<div class="item">
							<div class="top">
								<div class="left">
									<p class="num">
										STRATEGY <span class="color">02</span>
									</p>
									<p class="tit">효율적인 마케팅 전략</p>
								</div>
								<div class="right">
									<img src="img/ls7_icon2.png" alt="" class="icon">
								</div>
							</div>
							<div class="line"></div>
							<div class="bottom">
								<p class="desc">
									업종과 지역에 맞는 효과적인 마케팅 전략을 
									<br class="pc"><br class="tablet">
									실행하여 최고의 효율을 만들어 냅니다.
								</p>
							</div>
						</div>				
						<div class="item">
							<div class="top">
								<div class="left">
									<p class="num">
										STRATEGY <span class="color">03</span>
									</p>
									<p class="tit">전문성과 집중 관리</p>
								</div>
								<div class="right">
									<img src="img/ls7_icon3.png" alt="" class="icon">
								</div>
							</div>
							<div class="line"></div>
							<div class="bottom">
						...
						<div class="item">
							<div class="top">
								<div class="left">
									<p class="num">
										STRATEGY <span class="color">04</span>
									</p>
									<p class="tit">1:1 맞춤형 관리</p>
								</div>
								<div class="right">
									<img src="img/ls7_icon4.png" alt="" class="icon">
								</div>
							</div>
							<div class="line"></div>
							<div class="bottom">
								<p class="desc">
									모든 클라이언트에게 전담 1:1 담당자가 
									<br class="pc"><br class="tablet">
									배정되어 마케팅을 실행하고 관리합니다.
								</p>
							</div>
						</div>				
						<div class="item">
							<div class="top">
								<div class="left">
									<p class="num">
										STRATEGY <span class="color">05</span>
									</p>
									<p class="tit">지속적인 파트너쉽</p>
								</div>
								<div class="right">
									<img src="img/ls7_icon5.png" alt="" class="icon">
								</div>
							</div>
							<div class="line"></div>
							<div class="bottom">
								<p class="desc">
									마케팅브로와 함께 클라이언트는 최소 <br>
									1-2년 이상 협력 관계를 유지하고 있습니다.
								</p>
							</div>
						</div>				
						<div class="item">
							<div class="top">
								<div class="left">
									<p class="num">
										STRATEGY <span class="color">06</span>
									</p>
									<p class="tit">혁신적인 콘텐츠 제작</p>
								</div>
								<div class="right">
									<img src="img/ls7_icon6.png" alt="" class="icon">
								</div>
							</div>
							<div class="line"></div>
							<div class="bottom">
								<p class="desc">
									창의적이고 혁신적인 콘텐츠를 통해 브랜드 
									<br class="pc"><br class="tablet">
									가치를 소비자의 잠재의식에 각인시킵니다.
								</p>
							</div>
						</div>				
					</div>
			...
			<section class="landing_section sec8" id="PARTNERS">
				<div class="inner">
					...
					<div class="swiper_box">
						<div class="swiper sec8_swiper">
							<div class="swiper-wrapper">
								<div class="swiper-slide item">
									<div class="imgbox">
										<img src="img/ls8_img1-1.jpg" alt="">
									</div>
									<div class="txtbox">
										<div class="titbox">
											<p class="tit">
										...
										<div class="infobox">
											<p class="infotxt">
												월평균 매출 : <span class="color">2.4</span>억
											</p>
											<span class="bar"></span>
											<p class="infotxt">
												최고 월매출 : <span class="color">7.5</span>억
											</p>
										</div>
										<div class="infoimg">
											<img src="img/ls8_img1-2.jpg" alt="">
										</div>
									</div>
								</div>
								<div class="swiper-slide item">
									<div class="imgbox">
										<img src="img/ls8_img2-1.jpg" alt="">
									</div>
									<div class="txtbox">
										<div class="titbox">
											<p class="tit">
										...
										<div class="infobox">
											<p class="infotxt">
												월평균 매출 : <span class="color">1</span>억
											</p>
											<span class="bar"></span>
											<p class="infotxt">
												최고 월매출 : <span class="color">2.5</span>억
											</p>
										</div>
										<div class="infoimg">
											<img src="img/ls8_img2-2.jpg" alt="">
										</div>
									</div>
								</div>
								<div class="swiper-slide item">
									<div class="imgbox">
										<img src="img/ls8_img3-1.jpg" alt="">
									</div>
									<div class="txtbox">
										<div class="titbox">
											<p class="tit">
										...
										<div class="infobox">
											...
											<span class="bar"></span>
											<p class="infotxt">
												최고 월매출 : <span class="color">1.8</span>억
											</p>
										</div>
										<div class="infoimg">
											<img src="img/ls8_img3-2.jpg" alt="">
										</div>
									</div>
								</div>
							</div>
